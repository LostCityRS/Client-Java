...
@ObfuscatedName("i")
public final class JagString implements class187 {

	@ObfuscatedName("eb.O")
	public static final JagString field881 = wrap("sl_arrows");
	@ObfuscatedName("eb.Y")
	public static final JagString field891 = wrap("<col=ffffff> )4 ");
	@ObfuscatedName("i.h")
	...
	public JagString method611() {
		JagString var1 = Statics.method1375(this.toUserhash());
	...
	public int method627(JagString arg0) {
		...
		for (int var3 = 0; var3 < var2; var3++) {
			if (class233.field4373[this.chars[var3] & 0xFF] < class233.field4373[arg0.chars[var3] & 0xFF]) {
				return -1;
			}
			if (class233.field4373[this.chars[var3] & 0xFF] > class233.field4373[arg0.chars[var3] & 0xFF]) {
				return 1;
