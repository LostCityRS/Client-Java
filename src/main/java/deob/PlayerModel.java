...
public final class PlayerModel {
	...
	public void method635(Packet arg0) {
		...
		for (int var2 = 0; var2 < 7; var2++) {
			int var3 = this.field1667[AnimFrameSet.field2808[var2]];
			if (var3 == 0) {
				arg0.method141(-1);
			} else {
	...
	public ModelLit method637(SeqType arg0, SeqType arg1, int arg2, int arg3) {
		if (this.field1671 != -1) {
		...
		ModelLit var9 = (ModelLit) Js5.field379.method263(var5);
		if (var9 == null) {
			boolean var10 = false;
			...
			if (var10) {
				if (this.field1694 != -1L) {
					var9 = (ModelLit) Js5.field379.method263(this.field1694);
				}
				if (var9 == null) {
					return null;
				}
			...
			if (var9 == null) {
				...
				for (int var15 = 0; var15 < 12; var15++) {
					...
					if (var16 >= 256 && var16 < 512) {
						ModelLit var17 = Statics.method177(var16 - 256).method828();
						if (var17 != null) {
							var13[var14++] = var17;
						}
					}
					if (var16 >= 512) {
						ModelLit var18 = Statics.method760(var16 - 512).method941(this.field1658);
						if (var18 != null) {
							var13[var14++] = var18;
						}
					}
				}
				var9 = new ModelLit(var13, var14);
				for (int var19 = 0; var19 < 5; var19++) {
					if (this.field1688[var19] != 0) {
						var9.method771(MapSpotAnim.field2894[var19][0], MapSpotAnim.field2894[var19][this.field1688[var19]]);
						if (var19 == 1) {
							var9.method771(TextureManager.field1865[0], TextureManager.field1865[this.field1688[var19]]);
						}
					}
				}
				var9.method778();
	...
	public ModelLit method639() {
		...
		for (int var6 = 0; var6 < 12; var6++) {
			...
			if (var7 >= 256 && var7 < 512) {
				ModelLit var8 = Statics.method177(var7 - 256).method827();
				if (var8 != null) {
					var4[var5++] = var8;
				}
			}
			if (var7 >= 512) {
				ModelLit var9 = Statics.method760(var7 - 512).method948(this.field1658);
				if (var9 != null) {
					var4[var5++] = var9;
				}
			}
		...
		for (int var11 = 0; var11 < 5; var11++) {
			if (this.field1688[var11] != 0) {
				var10.method771(MapSpotAnim.field2894[var11][0], MapSpotAnim.field2894[var11][this.field1688[var11]]);
				if (var11 == 1) {
					var10.method771(TextureManager.field1865[0], TextureManager.field1865[this.field1688[var11]]);
				}
			}
		}
		return var10;
		...
		if (arg0 == null) {
			...
			for (int var5 = 0; var5 < 7; var5++) {
				for (int var6 = 0; var6 < Statics.field974; var6++) {
					IdkType var7 = Statics.method177(var6);
					if (var7 != null && !var7.field2373 && var5 + (arg1 ? 7 : 0) == var7.field2366) {
						arg0[AnimFrameSet.field2808[var5]] = var6 + 256;
						break;
					}
				}
			}
	...
	public void method642(int arg0, boolean arg1) {
		...
		int var3 = this.field1667[AnimFrameSet.field2808[arg0]];
		if (var3 == 0) {
			return;
		}
		var3 -= 256;
		...
		this.field1667[AnimFrameSet.field2808[arg0]] = var3 + 256;
		this.method638();
	}
	...
	public void method644(boolean arg0, int arg1) {
		...
		if (arg0) {
			var3++;
			if (var3 >= MapSpotAnim.field2894[arg1].length) {
				var3 = 0;
			}
		} else {
			var3--;
			if (var3 < 0) {
				var3 = MapSpotAnim.field2894[arg1].length - 1;
			}
		}
