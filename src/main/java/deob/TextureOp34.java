...
public final class TextureOp34 extends TextureOp {
	...
	public void method234(int arg0, int[] arg1) {
		...
		if (this.field595 == 1) {
			...
			if (this.field610) {
				for (int var18 = 0; var18 < Statics.field1276; var18++) {
					int var19 = this.field601 * Statics.field351[var18];
				...
				for (int var15 = 0; var15 < Statics.field1276; var15++) {
					int var16 = this.field601 * Statics.field351[var15];
		...
		if (var22 > 8 || var22 < -8) {
			...
			for (int var33 = 0; var33 < Statics.field1276; var33++) {
				int var34 = Statics.field351[var33] * this.field601;
		...
		for (int var36 = 1; var36 < this.field595; var36++) {
			...
			if (var37 > 8 || var37 < -8) {
				...
				if (this.field610 && var36 == this.field595 - 1) {
					for (int var51 = 0; var51 < Statics.field1276; var51++) {
						int var52 = this.field601 * Statics.field351[var51];
					...
					for (int var48 = 0; var48 < Statics.field1276; var48++) {
						int var49 = Statics.field351[var48] * this.field601;
