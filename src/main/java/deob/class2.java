...
@ObfuscatedName("aa")
public final class class2 extends class80 {
	...
	public class91 method41() {
		...
		class47 var2 = super.field1951 == -1 || this.field95 || super.field2000 == super.field1951 && var1 != null ? null : Statics.method103(super.field1951);
		class91 var3 = this.field90.method637(var1, var2, super.field1990, super.field1978);
		if (var3 == null) {
			return null;
		}
		var3.method766();
		...
		if (!this.field95 && this.field73 != null) {
			...
			if (this.field91 <= Linkable.field2063 && this.field82 > Linkable.field2063) {
				...
				class91[] var7 = new class91[] { var3, var6 };
				var3 = new class91(var7, 2, true);
				if (super.field1954 == 512) {
					var6.method781();
				} else if (super.field1954 == 1024) {
					var6.method781();
	...
	public void method43(class8 arg0) {
		arg0.field267 = 0;
		...
		for (int var10 = 0; var10 < 5; var10++) {
			...
			if (var11 < 0 || class116.field2894[var10].length <= var11) {
				var11 = 0;
			}
			var9[var10] = var11;
		}
