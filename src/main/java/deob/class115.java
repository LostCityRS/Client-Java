...
@ObfuscatedName("qd")
public abstract class class115 extends class26 {

	@ObfuscatedName("qd.ab")
	public static class32 field2692 = class73.method593("<br>(X", true);
	...
	public static class32 field2699 = class73.method593("null", true);
	...
	public static class32 field2702 = class73.method593("Drop", true);
	...
	public static class32 field2760 = class73.method593("titlebutton", true);
	...
	public static class32 field2762 = class73.method593("Please try using a different world)3", true);

	@ObfuscatedName("qd.tb")
	public int field2711 = 1;

	@ObfuscatedName("qd.tc")
	public static class32 field2763 = field2762;
	...
	public static class32 field2766 = field2762;

	@ObfuscatedName("qd.Bb")
	public static class32 field2719 = class73.method593("<)4col> x", true);

	@ObfuscatedName("qd.Vb")
	public static class32 field2739 = field2702;

	@ObfuscatedName("qd.Zb")
	public static int field2743 = 0;

	@ObfuscatedName("qd.Cb")
	public static class63 field2720 = new class63(500);

	@ObfuscatedName("qd.xc")
	public static int field2767 = 1;

	@ObfuscatedName("qd.zc")
	public static class32 field2769 = field2762;

	@ObfuscatedName("qd.Ac")
	public static class32 field2770 = field2762;

	@ObfuscatedName("qd.Bc")
	public static class32 field2771 = field2762;

	@ObfuscatedName("qd.Cc")
	public static class32 field2772 = field2762;

	@ObfuscatedName("qd.yc")
	public static class156 field2768 = new class156(512);
	...
	public static void method903() {
		...
		class44.field1026.method541((long) 0);
	}

	@ObfuscatedName("qd.h(I)V")
	public static void method904() {
		class38.field925.method490();
	}
	...
	public final void method900(int arg0, boolean arg1) {
		...
		if (this.field2712 != -1 && class97.method760(this.field2712).field3381 == 1) {
			this.field2712 = -1;
		}
		if (arg0 == 1) {
			var4++;
