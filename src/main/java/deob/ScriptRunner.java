		...
		try {
			...
			while (true) {
				...
				if (var382 < 100) {
					...
					if (var382 == 21) {
						...
						class141 var19 = Statics.field1446[--Statics.field4318];
				...
				if (var382 < 300) {
					...
					if (var382 < 1600) {
						...
						if (var382 == 2702) {
							...
							class168 var354 = (class168) Statics.field2395.method1049((long) var353);
							if (var354 == null) {
								Statics.field1944[var5++] = 0;
							} else {
								Statics.field1944[var5++] = 1;
						...
						if (var382 == 2704 || var382 == 2705) {
							...
							class168 var360 = (class168) Statics.field2395.method1049((long) var358);
						...
						if (var382 == 3305) {
							...
							Statics.field1944[var5++] = class105.field1907[var321];
							continue;
						}
						if (var382 == 3306) {
							var5--;
						...
						if (var382 == 3321) {
							Statics.field1944[var5++] = class240.field4458;
							continue;
						}
						if (var382 == 3322) {
						...
						if (var382 == 3400) {
							...
							EnumType var308 = EnumType.method1148(var306);
							Statics.field3330[var6++] = var308.method360(var307);
							continue;
						}
						if (var382 == 3408) {
							var5 -= 4;
							...
							EnumType var313 = EnumType.method1148(var310);
							if (var312 == var313.field873 && var309 == var313.field882) {
								if (var309 == 115) {
									Statics.field3330[var6++] = var313.method360(var311);
								} else {
						...
						if (var382 == 3622) {
							...
							if (Statics.field2078 != 0 && var95 < client.field1221) {
								Statics.field3330[var6++] = Statics.method1375(client.field1764[var95]).method614();
								continue;
							}
							Statics.field3330[var6++] = Statics.field1468;
							continue;
						...
						if (var382 == 4100) {
							...
							Statics.field3330[var6++] = JagString.join(new JagString[]{var254, Statics.method1212(var255)});
							continue;
						}
						if (var382 == 4101) {
							var6 -= 2;
						...
						if (var382 == 4104) {
							...
							Statics.field3330[var6++] = JagString.join(new JagString[]{Statics.method1212(var264), Statics.field2171, Statics.field992[var265], Statics.field2171, Statics.method1212(var266)});
							continue;
						}
						if (var382 == 4105) {
							var6 -= 2;
						...
						if (var382 == 4106) {
							...
							Statics.field3330[var6++] = Statics.method1212(var269);
							continue;
						}
						if (var382 == 4107) {
							var6 -= 2;
						...
						if (var382 == 4200) {
							...
							Statics.field3330[var6++] = ObjType.list(var160).field2892;
							continue;
						}
						if (var382 == 4201) {
							var5 -= 2;
						...
						if (var382 >= 4600) {
							if (var382 < 5100) {
								...
								if (var382 == 5055) {
									...
									Statics.field3330[var6++] = QuickChatPhraseTypeList.method1150(var216).method1410();
									continue;
								}
								if (var382 == 5056) {
									var5--;
									int var217 = Statics.field1944[var5];
									QuickChatPhraseTypeList var218 = QuickChatPhraseTypeList.method1150(var217);
								...
								if (var382 == 5057) {
									...
									Statics.field1944[var5++] = QuickChatPhraseTypeList.method1150(var220).field3916[var219];
									continue;
								}
								if (var382 == 5058) {
									Statics.field226 = new class217();
									var5--;
									Statics.field226.field4058 = Statics.field1944[var5];
									Statics.field226.field4065 = QuickChatPhraseTypeList.method1150(Statics.field226.field4058);
								...
								if (var382 == 5066) {
									...
									Statics.field1944[var5++] = QuickChatPhraseTypeList.method1150(var233).method1407();
									continue;
								}
								if (var382 == 5067) {
									var5 -= 2;
									...
									int var236 = QuickChatPhraseTypeList.method1150(var234).method1405(var235);
								...
								if (var382 == 5070) {
									...
									QuickChatPhraseTypeList var244 = QuickChatPhraseTypeList.method1150(var241);
								...
								if (var382 == 5202) {
									var5--;
									class86.method581(Statics.field1944[var5]);
									continue;
								}
								if (var382 == 5203) {
									var6--;
								...
								if (var382 == 5205) {
									var6--;
									class111.method764(Statics.field3330[var6]);
									continue;
								}
							} else if (var382 >= 5400) {
								if (var382 < 5500) {
			...
			if (var4.field4530 == null) {
				...
				if (var9 == 40) {
					...
					var378.method616(Statics.field2496).method616(Statics.method1212(var380));
				}
				if (client.modewhere != 0) {
