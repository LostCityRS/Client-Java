...
@ObfuscatedName("ub")
public final class class220 extends class23 {
	...
	@ObfuscatedName("ub.W")
	public static final class88 field4154 = class208.method1423(105, "Login limit exceeded)3");

	@ObfuscatedName("ub.hb")
	public static class88 field4165 = field4154;
	...
	public static class55 method1483(int arg0, Component arg1, class181 arg2, int arg3) {
		if (class11.field161 == 0) {
			throw new IllegalStateException();
		}
		try {
			class55 var4 = (class55) Class.forName("ii").getDeclaredConstructor().newInstance();
			var4.field1043 = arg3;
			var4.field1025 = new int[(class7.field99 ? 2 : 1) * 256];
			var4.method412(arg1);
			...
			if (class221.field4167 > 0 && class146.field2738 == null) {
				class146.field2738 = new class161();
				class146.field2738.field3109 = arg2;
				arg2.method1287(2, class146.field2738, class221.field4167);
			}
			if (class146.field2738 != null) {
				if (class146.field2738.field3102[arg0] != null) {
					throw new IllegalArgumentException();
				}
				class146.field2738.field3102[arg0] = var4;
			}
			return var4;
		} catch (Throwable var7) {
			try {
				class84 var5 = new class84(arg2, arg0);
				var5.field1025 = new int[(class7.field99 ? 2 : 1) * 256];
				var5.field1043 = arg3;
				var5.method412(arg1);
				...
				if (class146.field2738 != null) {
					...
					class146.field2738.field3102[arg0] = var5;
				}
				return var5;
	...
	public static void method1486(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
		class159 var9 = null;
		for (class159 var10 = (class159) class62.field1140.method1610(); var10 != null; var10 = (class159) class62.field1140.method1619()) {
		...
		if (var9 == null) {
			...
			var9.field3059 = arg7;
			var9.field3055 = arg6;
			class172.method1219(var9);
			class62.field1140.method1622(var9);
		}
		var9.field3062 = arg5;
		var9.field3068 = arg3;
		var9.field3061 = arg4;
	...
	public void method11(class46 arg0, int arg1) {
		...
		this.field4153 = new int[arg0.method347()][4];
		for (int var4 = 0; var4 < this.field4153.length; var4++) {
			this.field4153[var4][0] = arg0.method301();
			this.field4153[var4][1] = arg0.method347() << 4;
			this.field4153[var4][2] = arg0.method347() << 4;
			this.field4153[var4][3] = arg0.method347() << 4;
		}
	}
