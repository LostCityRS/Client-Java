...
public final class class100 extends class44 {
	...
	public void method851(class8 arg0) {
	...
	public class58 method852(int arg0) {
		class127.field3116 = false;
		...
		class58 var3 = (class58) class15.field500.method263((long) var2);
		if (var3 != null) {
			return var3;
		}
		class58 var4 = Statics.method846(0, Statics.field2810, var2);
		if (var4 == null) {
			class127.field3116 = true;
		} else {
			class15.field500.method262((long) var2, var4);
		}
		return var4;
	}

	@ObfuscatedName("qd.a(IZ)Ljd;")
	public class58 method857(boolean arg0) {
		class127.field3116 = false;
		int var2;
		if (arg0) {
			var2 = this.field2476;
	...
	public void method858(class8 arg0) {
		arg0.method144();
		this.field2442 = true;
		this.field2489 = arg0.method144();
		this.field2445 = arg0.method145();
	...
	public class91 method860(class47 arg0, int arg1, boolean arg2, class67 arg3) {
		class127.field3116 = false;
		int var5;
		int var6;
		if (arg2) {
		...
		if (var6 == 0) {
			...
			class91 var7 = (class91) class106.field2680.method263((long) ((var6 << 16) + var5));
			if (var7 == null) {
				if (var6 == 1) {
					var7 = class91.method798(Statics.field503, var5);
					if (var7 == null) {
						class127.field3116 = true;
						return null;
					}
	...
	public class10 method861() {
		class127.field3116 = false;
		if (this.field2448 == 65535) {
			return null;
		}
		class10 var1 = (class10) class133.field3249.method263((long) this.field2448);
		if (var1 != null) {
			return var1;
		}
		class10 var2 = Statics.method294(0, Statics.field2810, this.field2448);
		if (var2 == null) {
			class127.field3116 = true;
		} else {
			class133.field3249.method262((long) this.field2448, var2);
		}
		return var2;
	}
}
