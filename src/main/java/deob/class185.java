...
public final class class185 {
	...
	public void method1305(class46 arg0, class235 arg1) {
		...
		this.field3617[0] = arg0.method301();
		this.field3617[1] = arg0.method301();
		int var4 = arg0.method347();
		for (int var5 = 0; var5 < 2; var5++) {
			for (int var6 = 0; var6 < this.field3620[var5]; var6++) {
				this.field3614[var5][0][var6] = arg0.method301();
				this.field3616[var5][0][var6] = arg0.method301();
			}
		}
		for (int var7 = 0; var7 < 2; var7++) {
			for (int var8 = 0; var8 < this.field3620[var7]; var8++) {
				if ((var4 & 0x1 << var7 * 4 << var8) == 0) {
					...
					this.field3614[var7][1][var8] = arg0.method301();
					this.field3616[var7][1][var8] = arg0.method301();
				}
			}
		}
