...
public abstract class class99 extends class141 {
	...
	public static class32 field2288 = class73.method593("shad=", true);

	@ObfuscatedName("ob.bb")
	public int[] field2289;

	@ObfuscatedName("ob.cb")
	public static class32 field2290 = class73.method593("lt", true);

	@ObfuscatedName("ob.db")
	public static class32 field2291 = class73.method593(")4str", true);
	...
	public static class32 field2294 = class73.method593("u=", true);

	@ObfuscatedName("ob.hb")
	public static class32 field2295 = class73.method593(")4col", true);

	@ObfuscatedName("ob.ib")
	public static class51[] field2296;

	@ObfuscatedName("ob.jb")
	public static class32 field2297 = class73.method593("gt", true);
	...
	public static class32 field2300 = class73.method593(")4shad", true);

	@ObfuscatedName("ob.nb")
	public static class32 field2301 = class73.method593("str=", true);
	...
	public static class32 field2307 = class73.method593("str", true);

	@ObfuscatedName("ob.ub")
	public static class32 field2308 = class73.method593("u", true);

	@ObfuscatedName("ob.vb")
	public static class32 field2309 = class73.method593("shad", true);

	@ObfuscatedName("ob.wb")
	public static int field2310 = 0;

	@ObfuscatedName("ob.P")
	public static class32 field2279 = class73.method593(")4u", true);

	@ObfuscatedName("ob.R")
	public static int field2281 = -1;

	@ObfuscatedName("ob.T")
	public static class32 field2282 = class73.method593("img=", true);

	@ObfuscatedName("ob.U")
	public static class32 field2283 = class73.method593("col=", true);
	...
	public static class32 field2312 = class73.method593("br", true);

	@ObfuscatedName("ob.zb")
	public static Random field2313 = new Random();

	@ObfuscatedName("ob.Ab")
	public static class32[] field2314 = new class32[100];
	...
	public static class32 method771(class32 arg0) {
		int var1 = arg0.method240();
		int var2 = 0;
	...
	public static void method772(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		int var6 = arg1 + arg2 * class141.field3240;
		int var7 = class141.field3240 - arg3;
		int var8 = 0;
		int var9 = 0;
		if (arg2 < class141.field3236) {
			int var10 = class141.field3236 - arg2;
			arg4 -= var10;
			arg2 = class141.field3236;
			var9 = var10 * arg3;
			var6 += var10 * class141.field3240;
		}
		if (arg2 + arg4 > class141.field3239) {
			arg4 -= arg2 + arg4 - class141.field3239;
		}
		if (arg1 < class141.field3238) {
			int var11 = class141.field3238 - arg1;
			arg3 -= var11;
		...
		if (arg1 + arg3 > class141.field3241) {
			int var12 = arg1 + arg3 - class141.field3241;
			arg3 -= var12;
			var8 += var12;
			var7 += var12;
		}
		if (arg3 > 0 && arg4 > 0) {
			method792(class141.field3237, arg0, arg5, var9, var6, arg3, arg4, var7, var8);
		}
	}
	...
	public static void method785(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		...
		if (arg3 > 0 && arg4 > 0) {
			method778(class141.field3237, arg0, arg5, var10, var7, arg3, arg4, var8, var9, arg6);
		}
	}
	...
	public final int method769(class32 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
		if (arg0 == null) {
			return 0;
		}
	...
	public final int method770(class32 arg0) {
		if (arg0 == null) {
			return 0;
		}
		int var2 = -1;
		...
		for (int var5 = 0; var5 < arg0.field674; var5++) {
			...
			if (var6 == 60) {
				...
				if (var6 == 62 && var2 != -1) {
					class32 var7 = arg0.method241(var2 + 1, var5);
					var2 = -1;
	...
	public void method773(class32 arg0, int arg1) {
		int var3 = 0;
		boolean var4 = false;
		for (int var5 = 0; var5 < arg0.method240(); var5++) {
	...
	public final int method775(class32 arg0, int arg1) {
	...
	public final void method777(class32 arg0, int arg1, int arg2, int arg3, int arg4) {
		if (arg0 != null) {
	...
	public final void method779(class32 arg0, int arg1, int arg2, int arg3) {
		if (arg0 == null) {
			return;
		}
	...
	public void method780(class32 arg0, int arg1, int arg2, int[] arg3, int[] arg4) {
		...
		for (int var10 = 0; var10 < arg0.field674; var10++) {
			...
			if (var11 == 60) {
				...
				if (var11 == 62 && var7 != -1) {
					class32 var12 = arg0.method241(var7 + 1, var10);
					var7 = -1;
						...
						if (!var12.method272(field2297)) {
							if (var12.method262(field2282)) {
								try {
									...
									class51 var16 = field2296[var15];
									var16.method399(arg1 + var13, var6 + this.field2292 - var16.field1168 + var14);
				...
				if (var7 == -1) {
					...
					if (field2302 != -1) {
						class141.method1063(arg1, var6 + (int) ((double) this.field2292 * 0.7D), var21, field2302);
					}
					if (field2299 != -1) {
						class141.method1063(arg1, var6 + this.field2292, var21, field2299);
					}
					arg1 += var21;
					var8 = var11;
				}
	...
	public int method782(class32 arg0, int[] arg1, class32[] arg2) {
		if (arg0 == null) {
			return 0;
		}
		int var4 = 0;
		int var5 = 0;
		class32 var6 = class64.method491(100);
		int var7 = -1;
		int var8 = 0;
		byte var9 = 0;
		int var10 = -1;
		...
		for (int var14 = 0; var14 < var13; var14++) {
			...
			if (var15 == 60) {
				...
				if (var15 == 62 && var10 != -1) {
					class32 var16 = arg0.method241(var10 + 1, var14);
					var10 = -1;
					var6.method273(60);
					var6.method243(var16);
					var6.method273(62);
					if (var16.method272(field2312)) {
						arg2[var12++] = var6.method241(var5, var6.method240());
						var5 = var6.method240();
						var4 = 0;
						var7 = -1;
						var11 = -1;
						...
						try {
							...
							var4 += field2296[var17].field1169;
							var11 = -1;
				...
				if (var10 == -1) {
					...
					if (arg1 != null && var4 > arg1[var12 < arg1.length ? var12 : arg1.length - 1] && var7 >= 0) {
						arg2[var12++] = var6.method241(var5, var7 - var9);
						var5 = var7;
						var7 = -1;
						var4 -= var8;
						var11 = -1;
	...
	public final void method783(class32 arg0, int arg1, int arg2, int arg3, int arg4) {
		if (arg0 == null) {
			return;
		}
	...
	public void method784(class32 arg0) {
		try {
	...
	public void method786(class32 arg0, int arg1, int arg2) {
		...
		for (int var7 = 0; var7 < arg0.field674; var7++) {
			...
			if (var8 == 60) {
				...
				if (var8 == 62 && var5 != -1) {
					class32 var9 = arg0.method241(var5 + 1, var7);
					var5 = -1;
						...
						if (!var9.method272(field2297)) {
							if (var9.method262(field2282)) {
								try {
									...
									class51 var11 = field2296[var10];
									var11.method399(arg1, var4 + this.field2292 - var11.field1168);
				...
				if (var5 == -1) {
					...
					if (field2302 != -1) {
						class141.method1063(arg1, var4 + (int) ((double) this.field2292 * 0.7D), var14, field2302);
					}
					if (field2299 != -1) {
						class141.method1063(arg1, var4 + this.field2292 + 1, var14, field2299);
					}
					arg1 += var14;
					var6 = var8;
				}
	...
	public final void method787(class32 arg0, int arg1, int arg2, int arg3, int arg4) {
		if (arg0 == null) {
			return;
		}
		this.method781(arg3, 0);
	...
	public final int method789(class32 arg0, int arg1) {
	...
	public final void method790(class32 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		if (arg0 == null) {
			return;
		}
		this.method781(arg3, 0);
	...
	public final void method791(class32 arg0, int arg1, int arg2, int arg3, int arg4) {
		if (arg0 != null) {
			this.method781(arg3, arg4);
