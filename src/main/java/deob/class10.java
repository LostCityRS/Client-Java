...
@ObfuscatedName("bc")
public final class class10 extends class111 {
	...
	public void method202(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		...
		int var10 = 0;
		int var11 = 0;
		if (arg2 < class111.field2748) {
			int var12 = class111.field2748 - arg2;
			arg4 -= var12;
			arg2 = class111.field2748;
			var11 = arg3 * var12;
			var8 += Statics.field2749 * var12;
		}
		if (arg2 + arg4 > class111.field2751) {
			arg4 -= arg2 + arg4 - class111.field2751;
		}
		if (arg1 < class111.field2752) {
			int var13 = class111.field2752 - arg1;
			arg3 -= var13;
			arg1 = class111.field2752;
			var11 += var13;
			var8 += var13;
			var10 = var13;
			var9 += var13;
		}
		if (arg1 + arg3 > class111.field2753) {
			int var14 = arg1 + arg3 - class111.field2753;
			arg3 -= var14;
			var10 += var14;
			var9 += var14;
		}
	...
	public void method203(class1 arg0, int arg1, int arg2, int arg3, boolean arg4, int arg5) {
		...
		if (this.field358) {
			class111.method916(var12, (int) ((double) this.field350 * 0.7D) + var13, arg1 - var12, 8388608);
		}
	}
	...
	public void method205(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		int var10 = 0;
		if (arg2 < class111.field2748) {
			int var11 = class111.field2748 - arg2;
			arg4 -= var11;
			arg2 = class111.field2748;
			var10 = arg3 * var11;
		...
		if (arg1 < class111.field2752) {
			int var12 = class111.field2752 - arg1;
			arg3 -= var12;
			arg1 = class111.field2752;
			var10 += var12;
			var7 += var12;
		...
		if (arg1 + arg3 > class111.field2753) {
			int var13 = arg1 + arg3 - class111.field2753;
			arg3 -= var13;
			var9 += var13;
			var8 += var13;
		}
	...
	public void method206(class1 arg0, int arg1, int arg2, int arg3, boolean arg4) {
		...
		if (this.field358) {
			class111.method916(var6, (int) ((double) this.field350 * 0.7D) + var7, arg1 - var6, 8388608);
		}
	}
