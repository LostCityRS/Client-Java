...
public final class class174 {
	...
	@ObfuscatedName("q.s")
	public class88 field3383 = class66.field1188;
	...
	@ObfuscatedName("q.Kb")
	public static final class88 field3453 = class208.method1423(105, "");
	...
	@ObfuscatedName("q.Db")
	public class88 field3446 = class66.field1188;
	...
	@ObfuscatedName("q.Rb")
	public class88 field3460 = class158.field3043;
	...
	@ObfuscatedName("q.Ob")
	public class88 field3457 = class66.field1188;
	...
	@ObfuscatedName("q.Hc")
	public class174 field3502 = null;

	@ObfuscatedName("q.Rc")
	public class88 field3512 = class66.field1188;
	...
	@ObfuscatedName("q.Wb")
	public class174[] field3465;

	@ObfuscatedName("q.Qc")
	public class88[] field3511;
	...
	public static class193[] method1243() {
		class193[] var0 = new class193[class172.field3345];
	...
	public class30 method1245(class109 arg0, class209 arg1, int arg2, boolean arg3) {
		class248.field4549 = false;
		int var5;
		int var6;
		if (arg3) {
			var5 = this.field3376;
		...
		if (var5 == 0) {
			...
			class30 var7 = (class30) class168.field3236.method135((long) (var6 + (var5 << 16)));
			if (var7 == null) {
				class82 var8 = class82.method568(class90.field1704, var6);
				if (var8 == null) {
					class248.field4549 = true;
					return null;
				}
				var7 = var8.method546(64, 768, -50, -10, -50);
				class168.field3236.method130((long) ((var5 << 16) + var6), var7);
			}
			if (arg0 != null) {
			...
			class30 var9 = class147.method985(var6).method864(arg2, arg0);
			if (var9 == null) {
				class248.field4549 = true;
				return null;
			} else {
			...
			class30 var10 = arg1.method1428(arg0, arg2);
			if (var10 == null) {
				class248.field4549 = true;
				return null;
			} else {
			...
			class149 var11 = class71.method472(var6);
			class30 var12 = var11.method1025(10, arg2, arg0);
			if (var12 == null) {
				class248.field4549 = true;
				return null;
			} else {
			...
			class30 var13 = class147.method985(var6).method865(null, 0, arg2, arg0);
			if (var13 == null) {
				class248.field4549 = true;
				return null;
			} else {
	...
	public boolean method1246() {
		...
		class193 var1 = class233.method1553(class65.field1176, this.field3473);
		if (var1 == null) {
			return false;
		}
		var1.method1337();
	...
	public class188 method1248(int arg0) {
		class248.field4549 = false;
		...
		class188 var3 = (class188) class113.field2039.method665((long) var2);
		if (var3 != null) {
			return var3;
		}
		class188 var4 = class234.method1558(class65.field1176, var2, 0);
		if (var4 == null) {
			class248.field4549 = true;
		} else {
			class113.field2039.method663((long) var2, var4);
		}
		return var4;
	}

	@ObfuscatedName("q.a(ZI)Lrc;")
	public class188 method1249(boolean arg0) {
		int var2;
		if (arg0) {
			var2 = this.field3433;
		} else {
		...
		class188 var5 = (class188) class113.field2039.method665(var3);
		if (var5 != null) {
			return var5;
		}
		class169 var6 = class32.method203(class65.field1176, 0, var2);
		if (var6 == null) {
			class248.field4549 = true;
			return null;
		}
		...
		class113.field2039.method663(var3, var6);
		return var6;
	}

	@ObfuscatedName("q.a(BLea;)V")
	public void method1250(class46 arg0) {
		arg0.field831++;
		this.field3410 = true;
		this.field3390 = arg0.method347();
		this.field3439 = arg0.method301();
		this.field3391 = arg0.method334();
		this.field3514 = arg0.method334();
		this.field3501 = arg0.method301();
		this.field3418 = arg0.method301();
		this.field3463 = arg0.method324();
		this.field3394 = arg0.method324();
		this.field3367 = arg0.method324();
		this.field3451 = arg0.method324();
		this.field3504 = arg0.method301();
		if (this.field3504 == 65535) {
			this.field3504 = -1;
		} else {
			this.field3504 += this.field3423 & 0xFFFF0000;
		}
		this.field3378 = arg0.method347() == 1;
		if (this.field3390 == 0) {
			this.field3384 = arg0.method301();
			this.field3375 = arg0.method301();
			this.field3470 = arg0.method347() == 1;
		}
		if (this.field3390 == 5) {
			this.field3473 = arg0.method323();
			this.field3437 = arg0.method301();
			int var2 = arg0.method347();
			this.field3420 = (var2 & 0x1) != 0;
			this.field3477 = (var2 & 0x2) != 0;
			this.field3480 = arg0.method347();
			this.field3429 = arg0.method347();
			this.field3425 = arg0.method323();
			this.field3387 = arg0.method347() == 1;
			this.field3483 = arg0.method347() == 1;
		}
		if (this.field3390 == 6) {
			this.field3430 = 1;
			this.field3409 = arg0.method301();
			if (this.field3409 == 65535) {
				this.field3409 = -1;
			}
			this.field3432 = arg0.method334();
			this.field3405 = arg0.method334();
			this.field3455 = arg0.method301();
			this.field3509 = arg0.method301();
			this.field3517 = arg0.method301();
			this.field3485 = arg0.method301();
			this.field3404 = arg0.method301();
			if (this.field3404 == 65535) {
				this.field3404 = -1;
			}
			this.field3403 = arg0.method347() == 1;
			arg0.method301();
			if (this.field3463 != 0) {
				this.field3468 = arg0.method301();
			}
			if (this.field3394 != 0) {
				this.field3417 = arg0.method301();
			}
		}
		if (this.field3390 == 4) {
			this.field3461 = arg0.method301();
			if (this.field3461 == 65535) {
				this.field3461 = -1;
			}
			this.field3383 = arg0.method298();
			this.field3396 = arg0.method347();
			this.field3479 = arg0.method347();
			this.field3469 = arg0.method347();
			this.field3435 = arg0.method347() == 1;
			this.field3414 = arg0.method323();
		}
		if (this.field3390 == 3) {
			this.field3414 = arg0.method323();
			this.field3496 = arg0.method347() == 1;
			this.field3480 = arg0.method347();
		}
		if (this.field3390 == 9) {
			this.field3497 = arg0.method347();
			this.field3414 = arg0.method323();
			this.field3492 = arg0.method347() == 1;
		}
		this.field3494 = arg0.method304();
		int var3 = arg0.method347();
		if (var3 > 0) {
			this.field3493 = new byte[var3];
			for (int var4 = 0; var4 < var3; var4++) {
				this.field3493[var4] = arg0.method324();
			}
		}
		this.field3457 = arg0.method298();
		int var5 = arg0.method347();
		if (var5 > 0) {
			this.field3373 = new class88[var5];
			for (int var6 = 0; var6 < var5; var6++) {
				this.field3373[var6] = arg0.method298();
			}
		}
		this.field3413 = arg0.method347();
		this.field3475 = arg0.method347();
		this.field3427 = arg0.method347() == 1;
		this.field3512 = arg0.method298();
	...
	public int[] method1251(class46 arg0) {
		int var2 = arg0.method347();
		if (var2 == 0) {
			return null;
		}
		...
		for (int var4 = 0; var4 < var2; var4++) {
			var3[var4] = arg0.method323();
		}
		return var3;
	}

	@ObfuscatedName("q.a(I[Llj;)Lcc;")
	public class26 method1252(class130[] arg0) {
		class248.field4549 = false;
		if (this.field3461 == -1) {
			return null;
		}
		class26 var2 = (class26) class157.field3020.method665((long) this.field3461);
		if (var2 != null) {
			return var2;
		}
		class26 var3 = class106.method735(0, class106.field1926, this.field3461, class65.field1176);
		if (var3 == null) {
			class248.field4549 = true;
		} else {
			var3.method149(arg0, null);
			class157.field3020.method663((long) this.field3461, var3);
		}
		return var3;
	}

	@ObfuscatedName("q.a(BLi;I)V")
	public void method1253(class88 arg0, int arg1) {
		if (this.field3373 == null || arg1 >= this.field3373.length) {
			class88[] var3 = new class88[arg1 + 1];
	...
	public Object[] method1254(class46 arg0) {
		int var2 = arg0.method347();
		if (var2 == 0) {
			return null;
		}
		...
		for (int var4 = 0; var4 < var2; var4++) {
			int var5 = arg0.method347();
			if (var5 == 0) {
				var3[var4] = Integer.valueOf(arg0.method323());
			} else if (var5 == 1) {
				var3[var4] = arg0.method298();
			}
		}
		this.field3449 = true;
		return var3;
	...
	public void method1255(class46 arg0) {
		this.field3410 = false;
		this.field3390 = arg0.method347();
		this.field3368 = arg0.method347();
		this.field3439 = arg0.method301();
		this.field3391 = arg0.method334();
		this.field3514 = arg0.method334();
		this.field3501 = arg0.method301();
		...
		if (this.field3504 == 65535) {
			...
			this.field3504 = (this.field3423 & 0xFFFF0000) + this.field3504;
		}
		this.field3424 = arg0.method301();
		...
		if (var2 > 0) {
			...
			for (int var3 = 0; var3 < var2; var3++) {
				this.field3516[var3] = arg0.method347();
				this.field3486[var3] = arg0.method301();
			}
		}
		...
		if (var4 > 0) {
			...
			for (int var5 = 0; var5 < var4; var5++) {
				int var6 = arg0.method301();
				this.field3392[var5] = new int[var6];
				for (int var7 = 0; var7 < var6; var7++) {
					this.field3392[var5][var7] = arg0.method301();
		...
		if (this.field3390 == 2) {
			...
			this.field3466 = arg0.method347();
			this.field3508 = arg0.method347();
			...
			for (int var12 = 0; var12 < 20; var12++) {
				...
				if (var13 == 1) {
					...
					this.field3389[var12] = arg0.method323();
				} else {
					this.field3389[var12] = -1;
				}
			}
			this.field3511 = new class88[5];
			for (int var14 = 0; var14 < 5; var14++) {
				class88 var15 = arg0.method298();
		...
		if (this.field3390 == 4) {
			this.field3383 = arg0.method298();
			this.field3446 = arg0.method298();
		}
		if (this.field3390 == 1 || this.field3390 == 3 || this.field3390 == 4) {
			this.field3414 = arg0.method323();
		}
		if (this.field3390 == 3 || this.field3390 == 4) {
			this.field3513 = arg0.method323();
			this.field3431 = arg0.method323();
			this.field3374 = arg0.method323();
		}
		if (this.field3390 == 5) {
			this.field3473 = arg0.method323();
			this.field3433 = arg0.method323();
		}
		if (this.field3390 == 6) {
			this.field3430 = 1;
			this.field3409 = arg0.method301();
		...
		if (this.field3390 == 7) {
			...
			int var16 = arg0.method347();
			this.field3511 = new class88[5];
			if (var16 == 1) {
				this.field3494 |= 0x40000000;
			}
			for (int var17 = 0; var17 < 5; var17++) {
				class88 var18 = arg0.method298();
		...
		if (this.field3368 == 2 || this.field3390 == 2) {
			this.field3512 = arg0.method298();
			this.field3459 = arg0.method298();
			int var19 = arg0.method301() & 0x3F;
			this.field3494 |= var19 << 11;
		}
		if (this.field3368 == 1 || this.field3368 == 4 || this.field3368 == 5 || this.field3368 == 6) {
			this.field3460 = arg0.method298();
			if (this.field3460.method604() == 0) {
				if (this.field3368 == 1) {
					this.field3460 = class158.field3043;
				}
				if (this.field3368 == 4) {
					this.field3460 = class216.field4051;
				}
				if (this.field3368 == 5) {
					this.field3460 = class216.field4051;
				}
				if (this.field3368 == 6) {
					this.field3460 = class189.field3665;
				}
			}
		}
