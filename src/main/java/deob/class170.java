...
@ObfuscatedName("pg")
public final class class170 extends class51 {

	@ObfuscatedName("pg.cb")
	public final int[] field3279 = new int[16];

	@ObfuscatedName("pg.db")
	public static final class88 field3280 = class208.method1423(105, "Nehmen");
	...
	public final class127[][] field3295 = new class127[16][128];

	@ObfuscatedName("pg.ub")
	public static volatile int field3297 = -1;

	@ObfuscatedName("pg.wb")
	public final class127[][] field3299 = new class127[16][128];

	@ObfuscatedName("pg.Db")
	public static final class88 field3306 = class208.method1423(105, ": ");

	@ObfuscatedName("pg.D")
	public static final class88 field3254 = class208.method1423(105, "loc)3dat");
	...
	@ObfuscatedName("pg.C")
	public final class40 field3253 = new class40();

	@ObfuscatedName("pg.Lb")
	public final class105 field3314 = new class105(this);

	@ObfuscatedName("pg.B")
	public final class154 field3252 = new class154(128);
	...
	@ObfuscatedName("pg.L")
	public static class144 field3262;

	@ObfuscatedName("pg.Pb")
	public boolean field3318;

	@ObfuscatedName("pg.f(II)Li;")
	public static class88 method1212(int arg0) {
		return class219.method1481(false, arg0);
	}
	...
	@Override
	public synchronized class51 method385() {
		return this.field3314;
	}

	@ObfuscatedName("pg.c(I)V")
	public synchronized void method1180() {
		for (class204 var1 = (class204) this.field3252.method1047(); var1 != null; var1 = (class204) this.field3252.method1048()) {
			var1.method460();
		}
	}
	...
	public void method1181(int arg0) {
		...
		for (class127 var2 = (class127) this.field3314.field1913.method1610(); var2 != null; var2 = (class127) this.field3314.field1913.method1619()) {
	...
	public synchronized boolean method1182(class151 arg0, class91 arg1, class144 arg2) {
		arg1.method660();
		boolean var4 = true;
		int[] var5 = new int[] { 22050 };
		for (class153 var6 = (class153) arg1.field1715.method1047(); var6 != null; var6 = (class153) arg1.field1715.method1048()) {
			int var7 = (int) var6.field1219;
			class204 var8 = (class204) this.field3252.method1049((long) var7);
			if (var8 == null) {
				var8 = class176.method1266(arg2, var7);
				if (var8 == null) {
					var4 = false;
					continue;
				}
				this.field3252.method1052((long) var7, var8);
			}
	...
	public boolean method1183(int[] arg0, int arg1, int arg2, class127 arg3) {
		arg3.field2367 = class11.field161 / 100;
	...
	public synchronized void method1185(class91 arg0, boolean arg1) {
		this.method1208();
	...
	@Override
	public synchronized class51 method380() {
		return null;
	}
	...
	public int method1189(class127 arg0) {
	...
	public synchronized void method384(int arg0) {
		if (this.field3253.method263()) {
			int var2 = this.field3253.field706 * this.field3266 / class11.field161;
			do {
	...
	public int method1191(class127 arg0) {
		class121 var2 = arg0.field2368;
	...
	public int method1196(class127 arg0) {
		...
		int var10 = (int) ((double) (arg0.field2380.field4028 * 256) * Math.pow(2.0D, (double) var3 * 3.255208333333333E-4D) / (double) class11.field161 + 0.5D);
	...
	public boolean method1200(class127 arg0) {
	...
	public void method1201(int arg0, int arg1, int arg2) {
		class127 var4 = this.field3295[arg2][arg1];
		if (var4 == null) {
			return;
		}
		...
		for (class127 var5 = (class127) this.field3314.field1913.method1610(); var5 != null; var5 = (class127) this.field3314.field1913.method1619()) {
		...
		for (class127 var2 = (class127) this.field3314.field1913.method1610(); var2 != null; var2 = (class127) this.field3314.field1913.method1619()) {
			if (arg0 < 0 || var2.field2385 == arg0) {
				if (var2.field2391 != null) {
					var2.field2391.method1086(class11.field161 / 100);
	...
	public synchronized void method379(int[] arg0, int arg1, int arg2) {
		if (this.field3253.method263()) {
			int var4 = this.field3253.field706 * this.field3266 / class11.field161;
			do {
	...
	public void method1207(int arg0, int arg1, int arg2) {
		...
		if ((this.field3248[arg1] & 0x2) != 0) {
			for (class127 var4 = (class127) this.field3314.field1913.method1612(); var4 != null; var4 = (class127) this.field3314.field1913.method1617()) {
		...
		class204 var6 = (class204) this.field3252.method1049((long) this.field3305[arg1]);
		if (var6 == null) {
			return;
		}
		class213 var7 = var6.field3892[arg2];
		if (var7 == null) {
			return;
		}
		...
		if (this.field3286[arg1] == 0) {
			var8.field2391 = class162.method1098(var7, this.method1196(var8), this.method1191(var8), this.method1189(var8));
		} else {
			var8.field2391 = class162.method1098(var7, this.method1196(var8), 0, this.method1189(var8));
		...
		if (var8.field2384 >= 0) {
			class127 var9 = this.field3299[arg1][var8.field2384];
		...
		this.field3314.field1913.method1622(var8);
	...
	public void method1211(class127 arg0, boolean arg1) {
