...
public class client extends GameShell {
	...
	public final void method433(Component arg0, byte arg1) {
		...
		if (var3 >= 1 && var3 <= 100 || !(var3 < 701 || var3 > 800)) {
			...
			arg0.field127 = 150;
			arg0.field128 = (int) (Math.sin((double) field1588 / 40.0D) * 256.0D) & 0x7FF;
			if (this.field1196) {
	...
	public final void method435(boolean arg0) {
		byte[] var2 = this.field1390.method308("title.dat", null);
		...
		for (int var3 = 0; var3 < Model.field604; var3++) {
			...
			if (var2 != var4) {
				...
				if (var7 == 1) {
					...
					if (var11.field461.field996 == 1 && (var11.field404 & 0x7F) == 64 && (var11.field405 & 0x7F) == 64) {
	...
	public final void method449(int arg0) {
		...
		while (var2 != null) {
			if (this.field1479 != var2.field505 || field1588 > var2.field511) {
				var2.method119();
			} else if (field1588 >= var2.field510) {
				if (var2.field514 > 0) {
	...
	public final void method6() {
		...
		try {
			...
			if (!field1401) {
				...
				byte[] var54 = var14.method308("sounds.dat", null);
	...
	public final void method460(byte arg0) {
		...
		while (true) {
			...
			if (var2.field731 == 0) {
				...
				if ((this.field1525.method286(-250, var2.field732) & 0x62) != 0) {
					this.field1221 = true;
					if (this.field1396 != -1) {
						this.field1236 = true;
					}
	...
	public final void method465(int arg0) {
		...
		for (SpotAnimEntity var2 = (SpotAnimEntity) this.field1591.method257(); var2 != null; var2 = (SpotAnimEntity) this.field1591.method259(-976)) {
			if (this.field1479 != var2.field613 || var2.field619) {
				var2.method119();
			} else if (field1588 >= var2.field612) {
	...
	public final void method498(boolean arg0, Packet arg1, int arg2) {
		...
		for (int var5 = 0; var5 < this.field1288; var5++) {
			...
			if ((var8 & 0x40) == 64) {
				...
				var7.field440 = (var16 & 0xFFFF) + field1588;
				var7.field438 = 0;
				var7.field439 = 0;
	...
	public final void method522(int arg0, Packet arg1, int arg2, int arg3, PlayerEntity arg4) {
		...
		if ((arg0 & 0x100) == 256) {
			...
			arg4.field440 = (var25 & 0xFFFF) + field1588;
			arg4.field438 = 0;
			arg4.field439 = 0;
	...
	public final boolean method524(int arg0) {
		...
		try {
			...
			if (this.field1244 == -1) {
				...
				this.field1244 = this.field1484.field718[0] & 0xFF;
				if (this.field1537 != null) {
					this.field1244 = this.field1244 - this.field1537.method304() & 0xFF;
				}
			...
			if (this.field1243 == -1) {
				...
				this.field1274.method41(this.field1484.field718, 0, 1);
				this.field1243 = this.field1484.field718[0] & 0xFF;
				var2--;
			}
			if (this.field1243 == -2) {
				if (var2 <= 1) {
