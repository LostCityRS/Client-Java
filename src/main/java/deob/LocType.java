...
public final class LocType extends Linkable2 {
	...
	public class210 method997(int arg0, int[][] arg1, int[][] arg2, int arg3, boolean arg4, int arg5, int arg6, int arg7) {
		...
		if (var12 == null) {
			...
			if (var13 == null) {
				Statics.field3623.field3984 = null;
				return Statics.field3623;
			}
			var13.method563();
			if (var11) {
				var12 = var13;
		...
		if (var11) {
			var12 = ((ModelUnlit) var12).method558();
		}
		if (this.field2813 != 0) {
			if (var12 instanceof SoftwareModelLit) {
				var12 = ((SoftwareModelLit) var12).method847(this.field2813, this.field2787, arg2, arg1, arg3, arg7, arg5, true);
			} else if (var12 instanceof ModelUnlit) {
				var12 = ((ModelUnlit) var12).method545(this.field2813, this.field2787, arg2, arg1, arg3, arg7, arg5);
			}
		}
		Statics.field3623.field3984 = var12;
		return Statics.field3623;
	}
				...
				if (arg0 >= 30 && arg0 < 35) {
					...
					if (arg0 == 79) {
						...
						if (arg0 == 89) {
							...
							int var9 = arg1.g1();
							if (this.field2777 == null) {
								int var10 = Statics.bitceil(var9);
	...
	public class210 method1004(int arg0, int arg1, int arg2, int arg3, int arg4, SeqType arg5, int[][] arg6, int[][] arg7, int arg8) {
		long var10;
		if (this.field2811 == null) {
