...
public final class TextureOp5 extends TextureOp {
	...
	public int[] method54(int arg0) {
		...
		if (super.field379.field3098) {
			...
			for (int var8 = arg0 - this.field1753; var8 <= arg0 + this.field1753; var8++) {
				int[] var9 = this.method120(ClientMouseListener.field4158 & var8, 0);
				int[] var10 = new int[Statics.field1276];
				int var11 = 0;
				for (int var12 = -this.field1758; var12 <= this.field1758; var12++) {
					var11 += var9[Statics.field789 & var12];
				}
				int var13 = 0;
				while (Statics.field1276 > var13) {
					var10[var13] = var7 * var11 >> 16;
					int var14 = var11 - var9[var13 - this.field1758 & Statics.field789];
					var13++;
					var11 = var14 + var9[Statics.field789 & var13 + this.field1758];
				}
	...
	public void method11(Packet arg0, int arg1) {
		if (arg1 == 0) {
			this.field1758 = arg0.g1();
		} else if (arg1 == 1) {
			this.field1753 = arg0.g1();
		} else if (arg1 == 2) {
	...
	public int[][] method7(int arg0) {
		...
		if (super.field364.field4310) {
			...
			for (int var8 = arg0 - this.field1753; var8 <= arg0 + this.field1753; var8++) {
				int var9 = 0;
				int var10 = 0;
				int[][] var11 = this.method121(0, ClientMouseListener.field4158 & var8);
				int var12 = 0;
				int[][] var13 = new int[3][Statics.field1276];
				int[] var14 = var11[0];
				int[] var15 = var11[1];
				int[] var16 = var11[2];
				for (int var17 = -this.field1758; var17 <= this.field1758; var17++) {
					int var18 = var17 & Statics.field789;
					var10 += var16[var18];
					var12 += var14[var18];
					var9 += var15[var18];
				}
