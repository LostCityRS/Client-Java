...
@ObfuscatedName("ii")
public final class class96 extends class55 {
	...
	public int method398() {
		return this.field1779 - (this.field1775.available() >> (class7.field99 ? 2 : 1));
	}
	...
	public void method413() throws LineUnavailableException {
		...
		this.field1775 = null;
		Info var1 = new Info(SourceDataLine.class, this.field1776, this.field1779 << (class7.field99 ? 2 : 1));
	...
	public void method409(int arg0) throws LineUnavailableException {
		try {
			Info var2 = new Info(SourceDataLine.class, this.field1776, arg0 << (class7.field99 ? 2 : 1));
			this.field1775 = (SourceDataLine) AudioSystem.getLine(var2);
			this.field1775.open();
			this.field1775.start();
			this.field1779 = arg0;
		} catch (LineUnavailableException var4) {
			if (class155.method1057(arg0) == 1) {
				this.field1775 = null;
				throw var4;
			} else {
				this.method409(class184.method1296(arg0));
			}
		}
	}
	...
	public void method412(Component arg0) {
		...
		this.field1776 = new AudioFormat((float) class11.field161, 16, class7.field99 ? 2 : 1, true, false);
		this.field1778 = new byte[0x100 << (class7.field99 ? 2 : 1)];
	}
