...
@ObfuscatedName("da")
public final class class35 extends class23 {
	...
	public static final class88 field611 = class208.method1423(105, "wave2:");

	@ObfuscatedName("da.hb")
	public static final class88 field612 = field611;
	...
	public static final class248 field619 = new class248();

	@ObfuscatedName("da.qb")
	public static int field621 = 0;

	@ObfuscatedName("da.Z")
	public static final class88 field604 = class208.method1423(105, "Use");
	...
	public static void method232(int arg0, int arg1, int arg2, int arg3, class145 arg4, long arg5, boolean arg6) {
		if (arg4 == null) {
			return;
		}
	...
	public static void method233(int arg0) {
		if (arg0 == -1 || !class167.field3211[arg0]) {
			return;
		}
		class85.field1545.method955(arg0);
		if (class78.field1418[arg0] == null) {
			return;
		}
		boolean var1 = true;
		for (int var2 = 0; var2 < class78.field1418[arg0].length; var2++) {
			if (class78.field1418[arg0][var2] != null) {
				if (class78.field1418[arg0][var2].field3390 == 2) {
					var1 = false;
				} else {
					class78.field1418[arg0][var2] = null;
				}
			}
		}
		if (var1) {
		...
		class167.field3211[arg0] = false;
	}

	@ObfuscatedName("da.c(B)Lcf;")
	public static class29 method235() {
		try {
			return (class29) Class.forName("ji").getDeclaredConstructor().newInstance();
	...
	public void method11(class46 arg0, int arg1) {
		if (arg1 == 0) {
			this.field610 = arg0.method347() == 1;
		} else if (arg1 == 1) {
			this.field595 = arg0.method347();
		} else if (arg1 == 2) {
			...
			this.field601 = this.field596 = arg0.method347();
		} else if (arg1 == 4) {
			this.field600 = arg0.method347();
		} else if (arg1 == 5) {
			this.field601 = arg0.method347();
		} else if (arg1 == 6) {
			this.field596 = arg0.method347();
		}
	}
	...
	public int method231(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		int var9 = arg1 & 0xFFF;
		int var10 = var9 - 4096;
		int var11 = class92.field1720[var9];
		int var12 = var8 + 1;
		int var13 = var8 & 0xFF;
		if (var12 >= arg4) {
			var12 = 0;
	...
	public void method234(int arg0, int[] arg1) {
		int var3 = class111.field2021[arg0] * this.field596;
		if (this.field595 == 1) {
			...
			int var11 = class92.field1720[var10];
			int var12 = var9 + 1;
			if (var8 <= var12) {
				var12 = 0;
			}
			...
			if (this.field610) {
				for (int var18 = 0; var18 < class70.field1276; var18++) {
					int var19 = this.field601 * class22.field351[var18];
				...
				for (int var15 = 0; var15 < class70.field1276; var15++) {
					int var16 = this.field601 * class22.field351[var15];
		...
		if (var22 > 8 || var22 < -8) {
			...
			int var32 = class92.field1720[var30];
			for (int var33 = 0; var33 < class70.field1276; var33++) {
				int var34 = class22.field351[var33] * this.field601;
			...
			if (var37 > 8 || var37 < -8) {
				...
				if (this.field610 && var36 == this.field595 - 1) {
					...
					for (int var48 = 0; var48 < class70.field1276; var48++) {
						int var49 = class22.field351[var48] * this.field601;
	...
	public void method123() {
		this.field613 = class159.method1072(this.field600);
		this.method237();
