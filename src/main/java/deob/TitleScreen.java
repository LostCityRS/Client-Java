...
public class TitleScreen {
    ...
    public static void draw(PixfontGeneric arg0, PixfontGeneric arg1) {
        ...
        arg1.method141(JagString.join(new JagString[] { Text.field1326, Statics.field3787, Statics.method1212(client.worldid) }), 55, 478, 16777215, 0);
	...
	public static void loop(GameShell arg0) {
		...
		if (ClientMouseListener.field625 == 1 && ClientMouseListener.field4239 >= 715 && ClientMouseListener.field3339 >= 453) {
			...
			if (field2460) {
				...
				Statics.method388(client.songs, class86.field1552, 255);
			}
		}
		if (client.state == 5) {
			return;
	...
	public static void open(Js5 arg0, Component arg1, Js5 arg2) {
		...
		field4320 = PixLoader.method830(arg2, class245.field4502);
		...
		if (field2460) {
			...
			MidiManager.method730(255, class86.field1552, client.songs);
		}
	...
	public static void method535(int arg0) {
		...
		if (class32.field526 > field4169.length) {
			class32.field526 -= field4169.length;
		...
		for (int var5 = 0; var5 < var4; var5++) {
			int var6 = field3667[var3 + var2] - arg0 * field4169[field4169.length - 1 & class32.field526 + var2] / 6;
			if (var6 < 0) {
				var6 = 0;
			}
			field3667[var2++] = var6;
		...
		if (Statics.field3099 > 0) {
			Statics.field3099 -= arg0 * 4;
		}
		if (Statics.field2969 > 0) {
			Statics.field2969 -= arg0 * 4;
		}
		if (Statics.field2969 == 0 && Statics.field3099 == 0) {
			int var11 = (int) (Math.random() * (double) (2000 / arg0));
			if (var11 == 1) {
				Statics.field3099 = 1024;
			}
			if (var11 == 0) {
				Statics.field2969 = 1024;
			}
		}
		...
		for (int var13 = 256 - arg0; var13 < 256; var13++) {
			class240.field4454[var13] = (int) (Math.sin((double) Statics.field924 / 14.0D) * 16.0D + Math.sin((double) Statics.field924 / 15.0D) * 14.0D + Math.sin((double) Statics.field924 / 16.0D) * 12.0D);
			Statics.field924++;
		}
	...
	public static void method804(PixfontGeneric arg0, PixfontGeneric arg1) {
		...
		do {
			var4 = var2;
			var5 = var3;
			if (Statics.field1895 <= var2 * (var3 - 1)) {
				var3--;
			}
			if (var3 * (var2 - 1) >= Statics.field1895) {
				var2--;
			}
			if (Statics.field1895 <= (var2 - 1) * var3) {
				var2--;
			}
		...
		int var11 = var10 + 23;
		int var12 = 0;
		for (int var13 = 0; var13 < Statics.field1895; var13++) {
			class70 var14 = Statics.field3845[var13];
			boolean var15 = true;
			JagString var16 = Statics.method1212(var14.field1255);
			...
			arg1.method141(Statics.method1212(var14.field1261), var9 + 15, 5 + 9 + var11, 0, -1);
	...
	public static void method1307() {
		if (Statics.field2969 > 0) {
			for (int var0 = 0; var0 < 256; var0++) {
				if (Statics.field2969 > 768) {
					field3034[var0] = Statics.method1525(field234[var0], 1024 - Statics.field2969, field32[var0]);
				} else if (Statics.field2969 <= 256) {
					field3034[var0] = Statics.method1525(field32[var0], 256 - Statics.field2969, field234[var0]);
				} else {
					field3034[var0] = field234[var0];
				}
			}
		} else if (Statics.field3099 > 0) {
			for (int var1 = 0; var1 < 256; var1++) {
				if (Statics.field3099 > 768) {
					field3034[var1] = Statics.method1525(field3014[var1], 1024 - Statics.field3099, field32[var1]);
				} else if (Statics.field3099 <= 256) {
					field3034[var1] = Statics.method1525(field32[var1], 256 - Statics.field3099, field3014[var1]);
				} else {
