...
public final class TextureOp20 extends TextureOp {
	...
	public int[] method54(int arg0) {
		...
		if (super.field379.field3098) {
			int var3 = Statics.field1276 / this.field163;
			int var4 = Statics.field460 / this.field167;
			int[] var6;
			if (var4 > 0) {
				int var5 = arg0 % var4;
				var6 = this.method120(var5 * Statics.field460 / var4, 0);
			} else {
			...
			for (int var7 = 0; var7 < Statics.field1276; var7++) {
				if (var3 <= 0) {
					...
					int var8 = var7 % var3;
					var2[var7] = var6[var8 * Statics.field1276 / var3];
				}
			}
		}
		return var2;
	...
	public int[][] method7(int arg0) {
		...
		if (super.field364.field4310) {
			int var3 = Statics.field460 / this.field167;
			int var4 = Statics.field1276 / this.field163;
			int[][] var6;
			if (var3 > 0) {
				int var5 = arg0 % var3;
				var6 = this.method121(0, Statics.field460 * var5 / var3);
			} else {
			...
			for (int var13 = 0; var13 < Statics.field1276; var13++) {
				...
				if (var4 > 0) {
					...
					var15 = Statics.field1276 * var14 / var4;
				} else {
					var15 = 0;
				}
