...
public final class class148 extends class146 {
	...
	public class148(class66 arg0) {
		...
		for (int var3 = 0; var3 < var2; var3++) {
			this.field3363[var3] = arg0.method531();
		}
		if (var2 > 1) {
			this.field3364 = new int[var2 - 1];
			for (int var4 = 0; var4 < var2 - 1; var4++) {
				this.field3364[var4] = arg0.method532();
			}
		}
		if (var2 > 1) {
			this.field3362 = new int[var2 - 1];
			for (int var5 = 0; var5 < var2 - 1; var5++) {
				this.field3362[var5] = arg0.method532();
			}
		}
		this.field3357 = new int[var2];
		for (int var6 = 0; var6 < var2; var6++) {
			this.field3357[var6] = arg0.method538();
		}
		this.field3356 = arg0.method532();
		this.field3355 = arg0.method532();
		this.field3361 = null;
	}
	...
	public boolean method1105(double arg0, int arg1, class30 arg2) {
		...
		for (int var7 = 0; var7 < this.field3363.length; var7++) {
			class51 var8 = class52.method408(arg2, this.field3363[var7]);
			var8.method398();
