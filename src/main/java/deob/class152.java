...
public final class class152 {
	...
	@ObfuscatedName("vf.e")
	public static class32 field3478 = class73.method593(" from your ignore list first", true);

	@ObfuscatedName("vf.g")
	public int field3480;

	@ObfuscatedName("vf.h")
	public static class32 field3481 = class73.method593("Verbindung abgebrochen)3", true);
	...
	@ObfuscatedName("vf.m")
	public static class32 field3486 = field3478;
	...
	@ObfuscatedName("vf.p")
	public static short[][] field3489 = new short[][] { new short[0], { 9104, 10275, 7595, 3610, 7975, 8526, 918, -26734, 24466, 10145, -6882, 5027, 1457, 16565, -30545, 25486 }, new short[0], new short[0], new short[0] };

	@ObfuscatedName("vf.w")
	public long field3496;

	@ObfuscatedName("vf.z")
	public static class32 field3499 = class73.method593("Cabbage", true);

	@ObfuscatedName("vf.x")
	public static int field3497 = 0;

	@ObfuscatedName("vf.I")
	public static class32 field3508 = class73.method593(":", true);

	@ObfuscatedName("vf.y")
	public int field3498 = 0;

	@ObfuscatedName("vf.C")
	public final class78 field3502;
	...
	@ObfuscatedName("vf.A")
	public static class152 field3500;

	@ObfuscatedName("vf.a(IB)V")
	public static void method1176() {
		class73.field1724 = 2;
		class157.field3606 = -1;
		class98.field2263 = 1;
		class34.field718 = null;
		class57.field1321 = 0;
		class121.field2870 = false;
		class126.field2928 = -1;
	}

	@ObfuscatedName("vf.a(II)Lee;")
	public static class34 method1177(int arg0) {
		class34 var1 = (class34) class2.field24.method485((long) arg0);
		if (var1 != null) {
			return var1;
		}
		byte[] var2 = class91.field2086.method206(1, arg0);
		class34 var3 = new class34();
		if (var2 != null) {
			var3.method291(arg0, new class66(var2));
		}
		var3.method292();
		class2.field24.method484((long) arg0, var3);
		return var3;
	}
	...
	public static void method1186(class32 arg0) {
		if (class145.field3301 >= 2) {
			if (arg0.method271(class2.field28)) {
				System.gc();
			}
			if (arg0.method271(class86.field2013)) {
				class65.method503();
			}
			if (arg0.method271(class84.field1969)) {
				class157.field3605 = true;
			}
			if (arg0.method271(class68.field1593)) {
				class157.field3605 = false;
			}
			if (arg0.method271(class20.field372)) {
				for (int var1 = 0; var1 < 4; var1++) {
					for (int var2 = 1; var2 < 103; var2++) {
						for (int var3 = 1; var3 < 103; var3++) {
							class105.field2482[var1].field2811[var2][var3] = 0;
						}
					}
				}
			}
			if (arg0.method271(class43.field1000) && class70.field1646 == 2) {
				throw new RuntimeException();
			}
			if (arg0.method262(class140.field3223)) {
				class92.field2116 = arg0.method268(12).method275().method261();
				class79.method628(class52.method402(new class32[] { class63.field1441, class159.method1228(class92.field2116) }), 0, null);
			}
			if (arg0.method271(class143.field3276)) {
				class146.field3318 = true;
			}
		}
		class44.field1026.method356(89);
		class44.field1026.method514(arg0.method240() - 1);
		class44.field1026.method521(arg0.method268(2));
	}
	...
	public static void method1187() {
		...
		while (!var0) {
			var0 = true;
			for (int var1 = 0; var1 < class119.field2849 - 1; var1++) {
				if (class44.field1034[var1] < 1000 && class44.field1034[var1 + 1] > 1000) {
					class32 var2 = class56.field1295[var1];
					var0 = false;
					class56.field1295[var1] = class56.field1295[var1 + 1];
					class56.field1295[var1 + 1] = var2;
					class32 var3 = class109.field2575[var1];
					class109.field2575[var1] = class109.field2575[var1 + 1];
					class109.field2575[var1 + 1] = var3;
					int var4 = class44.field1034[var1];
					class44.field1034[var1] = class44.field1034[var1 + 1];
					class44.field1034[var1 + 1] = var4;
					int var5 = class121.field2868[var1];
					class121.field2868[var1] = class121.field2868[var1 + 1];
					class121.field2868[var1 + 1] = var5;
					int var6 = class158.field3620[var1];
					class158.field3620[var1] = class158.field3620[var1 + 1];
					class158.field3620[var1 + 1] = var6;
					int var7 = class135.field3135[var1];
					class135.field3135[var1] = class135.field3135[var1 + 1];
					class135.field3135[var1 + 1] = var7;
				}
			}
		}
	}
	...
	public void method1175(byte[] arg0, int arg1, int arg2) throws IOException {
		try {
			...
			if (this.field3483 != -1L && (long) arg1 + this.field3482 > (long) this.field3477.length + this.field3483) {
				...
				arg1 -= var4;
				class60.method457(arg0, arg2, this.field3477, (int) (this.field3482 - this.field3483), var4);
				this.field3482 += var4;
				arg2 += var4;
			...
			if (arg1 > this.field3477.length) {
				...
				if (var5 > -1L && var5 < var7) {
					...
					class60.method457(arg0, (int) (var5 + (long) arg2 - this.field3482), this.field3488, (int) (var5 - this.field3475), var9);
				}
				this.field3482 += arg1;
			} else if (arg1 > 0) {
				...
				class60.method457(arg0, arg2, this.field3477, (int) (this.field3482 - this.field3483), arg1);
				this.field3482 += arg1;
	...
	public void method1179() throws IOException {
		this.method1181();
	...
	public void method1180(int arg0, byte[] arg1, int arg2) throws IOException {
		try {
			...
			if (this.field3483 != -1L && this.field3482 >= this.field3483 && this.field3483 + (long) this.field3498 >= (long) arg0 + this.field3482) {
				class60.method457(this.field3477, (int) (this.field3482 - this.field3483), arg1, 0, arg0);
				this.field3482 += arg0;
				return;
			}
			...
			if (this.field3482 >= this.field3475 && (long) this.field3480 + this.field3475 > this.field3482) {
				...
				arg0 -= var7;
				class60.method457(this.field3488, (int) (this.field3482 - this.field3475), arg1, 0, var7);
				arg2 = var7;
				this.field3482 += var7;
			}
			if (arg0 > this.field3488.length) {
				...
				class60.method457(this.field3488, 0, arg1, arg2, var8);
				arg0 -= var8;
				this.field3482 += var8;
				arg2 += var8;
			}
			if (this.field3483 != -1L) {
				...
				if (var13 > -1L && var13 < var11) {
					...
					class60.method457(this.field3477, (int) (var13 - this.field3483), arg1, (int) (var13 - var4), var15);
	...
	public void method1181() throws IOException {
		...
		if (var1 > -1L && var3 > var1) {
			...
			class60.method457(this.field3477, (int) (var1 - this.field3483), this.field3488, (int) (var1 - this.field3475), var5);
		}
		this.field3483 = -1L;
		this.field3498 = 0;
	}
