...
@ObfuscatedName("ka")
public final class class61 extends class87 {
	...
	public int method579(int[] arg0, int arg1, int arg2, int arg3, int arg4) {
		if (this.field1533 > 0) {
			...
			if (this.field1534 == -256 && (this.field1540 & 0xFF) == 0) {
				arg1 = method584(((class135) super.field2168).field3308, arg0, this.field1540, arg1, this.field1537, this.field1530, this.field1531, var6, arg2, this);
			} else {
				arg1 = method581(((class135) super.field2168).field3308, arg0, this.field1540, arg1, this.field1537, this.field1530, this.field1531, var6, arg2, this, this.field1534, arg4);
			}
			this.field1533 -= arg1;
			if (this.field1533 != 0) {
				return arg1;
		...
		return this.field1534 == -256 && (this.field1540 & 0xFF) == 0 ? method586(((class135) super.field2168).field3308, arg0, this.field1540, arg1, this.field1537, arg3, arg2, this) : method583(((class135) super.field2168).field3308, arg0, this.field1540, arg1, this.field1537, arg3, arg2, this, this.field1534, arg4);
	}
	...
	public synchronized int method134(int[] arg0, int arg1, int arg2) {
		...
		class135 var4 = (class135) super.field2168;
	...
	public static int method580(byte[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, class61 arg9, int arg10, int arg11) {
		int var12;
	...
	public static int method581(byte[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, class61 arg9, int arg10, int arg11) {
		int var12;
	...
	public static int method583(byte[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, class61 arg7, int arg8, int arg9) {
		int var10;
	...
	public static int method584(byte[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, class61 arg9) {
		int var10 = arg2 >> 8;
		int var11 = arg8 >> 8;
		int var12 = arg4 << 8;
		int var13 = arg6 << 8;
	...
	public static int method586(byte[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, class61 arg7) {
		int var8 = arg2 >> 8;
		int var9 = arg6 >> 8;
		int var10 = arg4 << 8;
		int var11;
	...
	public static int method587(byte[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, class61 arg9) {
		int var10 = arg2 >> 8;
		int var11 = arg8 >> 8;
		int var12 = arg4 << 8;
		int var13 = arg6 << 8;
	...
	public int method588() {
		...
		if (this.field1536 == 0) {
			var2 -= this.field1540 * var2 / (((class135) super.field2168).field3308.length << 8);
		} else if (this.field1536 >= 0) {
			var2 -= this.field1532 * var2 / ((class135) super.field2168).field3308.length;
		}
	...
	public static class61 method590(class135 arg0, int arg1) {
		return arg0.field3308 == null || arg0.field3308.length == 0 ? null : new class61(arg0, (int) ((long) arg0.field3311 * 256L * (long) 100 / (long) (Statics.field192 * 100)), arg1);
	}

	@ObfuscatedName("ka.b(II[B[IIIIIIILka;II)I")
	public static int method591(byte[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, class61 arg7, int arg8, int arg9) {
		int var10;
	...
	public synchronized void method127(int arg0) {
		...
		class135 var2 = (class135) super.field2168;
	...
	public int method592(int[] arg0, int arg1, int arg2, int arg3, int arg4) {
		if (this.field1533 > 0) {
			...
			this.field1533 += arg1;
			if (this.field1534 == 256 && (this.field1540 & 0xFF) == 0) {
				arg1 = method587(((class135) super.field2168).field3308, arg0, this.field1540, arg1, this.field1537, this.field1530, this.field1531, var6, arg2, this);
			} else {
				arg1 = method580(((class135) super.field2168).field3308, arg0, this.field1540, arg1, this.field1537, this.field1530, this.field1531, var6, arg2, this, this.field1534, arg4);
			}
			this.field1533 -= arg1;
			if (this.field1533 != 0) {
				return arg1;
		...
		return this.field1534 == 256 && (this.field1540 & 0xFF) == 0 ? method593(((class135) super.field2168).field3308, arg0, this.field1540, arg1, this.field1537, arg3, arg2, this) : method591(((class135) super.field2168).field3308, arg0, this.field1540, arg1, this.field1537, arg3, arg2, this, this.field1534, arg4);
	}

	@ObfuscatedName("ka.b([B[IIIIIIILka;)I")
	public static int method593(byte[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, class61 arg7) {
		int var8 = arg2 >> 8;
		int var9 = arg6 >> 8;
		int var10 = arg4 << 8;
		int var11;
	...
	public class61(class135 arg0, int arg1, int arg2) {
