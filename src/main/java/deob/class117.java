...
public final class class117 {
	...
	@ObfuscatedName("qf.k")
	public static class32 field2787 = class73.method593(" more options", true);
	...
	@ObfuscatedName("qf.p")
	public static boolean field2792 = false;
	...
	@ObfuscatedName("qf.u")
	public static class32 field2797 = field2787;

	@ObfuscatedName("qf.v")
	public final int field2798 = 104;

	@ObfuscatedName("qf.G")
	public static class32 field2809;

	@ObfuscatedName("qf.E")
	public static class36 field2807;
	...
	@ObfuscatedName("qf.D")
	public static class32 field2806;

	@ObfuscatedName("qf.K")
	public static class32 field2813;
	...
	static {
		...
		field2809 = class73.method593("Lade Benutzeroberfl-=che )2 ", true);
		field2807 = null;
		field2808 = class73.method593("Clientscript error )2 check log for details", true);
		field2810 = class73.method593("skill)2", true);
		field2806 = class73.method593("Lade Wordpack )2 ", true);
		field2813 = field2810;
	...
	public static boolean method922(class32 arg0) {
		...
		for (int var1 = 0; var1 < class2.field20; var1++) {
			if (arg0.method271(class14.field239[var1])) {
				return true;
			}
		}
		return arg0.method271(class20.field373.field1659);
	}
	...
	public static void method926(int arg0) {
		if (arg0 == -1 || !class92.field2119[arg0]) {
			return;
		}
		class85.field1991.method221(arg0);
		if (class79.field1825[arg0] == null) {
			return;
		}
		boolean var1 = true;
		for (int var2 = 0; var2 < class79.field1825[arg0].length; var2++) {
			if (class79.field1825[arg0][var2] != null) {
				if (class79.field1825[arg0][var2].field755 == 2) {
					var1 = false;
				} else {
					class79.field1825[arg0][var2] = null;
				}
			}
		}
		if (var1) {
			class79.field1825[arg0] = null;
		}
		class92.field2119[arg0] = false;
	}

	@ObfuscatedName("qf.a(Z)V")
	public static void method927() {
		class134.field3129 = null;
		class134.field3123 = null;
		class85.field1985 = null;
		class68.field1592 = null;
		class37.field894 = null;
		class111.field2612 = null;
		class106.field2511 = null;
		class103.field2426 = null;
		class143.field3272 = null;
		field2814 = null;
		class33.field698 = null;
