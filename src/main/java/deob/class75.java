...
public final class class75 implements class88 {
	...
	public int[] method692(int arg0) {
		class90 var2 = this.field1867[arg0];
		if (var2 != null) {
			...
			if (var3) {
				if (this.field1880 == 0) {
					class90 var4 = (class90) this.field1854.method799();
					var4.method764();
				} else {
					this.field1880--;
				}
	...
	public void method697(int arg0) {
		for (int var2 = 0; var2 < this.field1867.length; var2++) {
			class90 var3 = this.field1867[var2];
	...
	public class75(Js5 arg0, Js5 arg1, int arg2, double arg3, int arg4) {
		...
		this.field1867 = new class90[arg0.method235(0)];
		for (int var9 = 0; var9 < var8; var9++) {
			class8 var10 = new class8(arg0.method217(var7[var9], 0));
			this.field1867[var7[var9]] = new class90(var10);
		}
	}
}
