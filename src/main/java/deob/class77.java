...
public final class class77 {
	...
	@ObfuscatedName("me.a")
	public final class125[] field1904 = new class125[10];
	...
	public class135 method710() {
		byte[] var1 = this.method708();
		return new class135(22050, var1, this.field1905 * 22050 / 1000, this.field1906 * 22050 / 1000);
	}

	public class77(class8 arg0) {
		for (int var2 = 0; var2 < 10; var2++) {
			int var3 = arg0.method144();
			if (var3 != 0) {
				arg0.field267--;
				this.field1904[var2] = new class125();
