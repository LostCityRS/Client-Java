...
public abstract class class123 extends class45 {
	...
	public final void method996(int arg0, int arg1, long arg2) {
		...
		if (class89.field2180 == var5) {
			return;
		}
		class89.field2180 = var5;
	...
	public final void method1000(long arg0) {
		for (int var3 = 0; var3 < 128; var3++) {
			int var4 = class79.field1937[var3];
			class79.field1937[var3] = 0;
			for (int var5 = 0; var5 < 16; var5++) {
				if ((var4 & 0x1 << var5) != 0) {
	...
	public final boolean method1001(int arg0, int arg1, int arg2, long arg3) {
		if ((arg0 & 0xE0) == 128) {
			...
			int var7 = class79.field1937[arg1];
			if (arg0 < 144 || arg2 == 0) {
				class79.field1937[arg1] = var7 & ~var6;
			} else if ((var7 & var6) == 0) {
				class79.field1937[arg1] = var7 | var6;
			} else {
