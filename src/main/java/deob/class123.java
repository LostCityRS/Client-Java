...
public final class class123 {
	...
	@ObfuscatedName("lc.l")
	public class235 field2243;

	@ObfuscatedName("lc.m")
	public class235 field2244;
	...
	@ObfuscatedName("lc.p")
	public class235 field2247;

	@ObfuscatedName("lc.q")
	public static final int[] field2248;

	@ObfuscatedName("lc.r")
	public class235 field2249;
	...
	public int[] method833(int arg0, int arg1) {
		class124.method835(field2235, 0, arg0);
		if (arg1 < 10) {
			return field2235;
		}
		...
		if (this.field2240.field3620[0] > 0 || this.field2240.field3620[1] > 0) {
			...
			if (arg0 >= var30 + var31) {
				...
				while (var32 < var33) {
					int var34 = (int) ((long) field2235[var32 + var30] * (long) class185.field3615 >> 16);
					for (int var35 = 0; var35 < var30; var35++) {
						var34 += (int) ((long) field2235[var32 + var30 - var35 - 1] * (long) class185.field3619[0][var35] >> 16);
					}
					for (int var36 = 0; var36 < var32; var36++) {
						var34 -= (int) ((long) field2235[var32 - var36 - 1] * (long) class185.field3619[1][var36] >> 16);
					}
				...
				while (true) {
					...
					while (var32 < var37) {
						int var38 = (int) ((long) field2235[var32 + var30] * (long) class185.field3615 >> 16);
						for (int var39 = 0; var39 < var30; var39++) {
							var38 += (int) ((long) field2235[var32 + var30 - var39 - 1] * (long) class185.field3619[0][var39] >> 16);
						}
						for (int var40 = 0; var40 < var31; var40++) {
							var38 -= (int) ((long) field2235[var32 - var40 - 1] * (long) class185.field3619[1][var40] >> 16);
						}
					...
					if (var32 >= arg0 - var30) {
						while (var32 < arg0) {
							...
							for (int var42 = var32 + var30 - arg0; var42 < var30; var42++) {
								var41 += (int) ((long) field2235[var32 + var30 - var42 - 1] * (long) class185.field3619[0][var42] >> 16);
							}
							for (int var43 = 0; var43 < var31; var43++) {
								var41 -= (int) ((long) field2235[var32 - var43 - 1] * (long) class185.field3619[1][var43] >> 16);
							}
	...
	public void method834(class46 arg0) {
		this.field2232 = new class235();
		this.field2232.method1563(arg0);
		this.field2253 = new class235();
		this.field2253.method1563(arg0);
		int var2 = arg0.method347();
		if (var2 != 0) {
			arg0.field831--;
			this.field2244 = new class235();
			this.field2244.method1563(arg0);
			this.field2237 = new class235();
			this.field2237.method1563(arg0);
		}
		int var3 = arg0.method347();
		if (var3 != 0) {
			arg0.field831--;
			this.field2256 = new class235();
		...
		this.field2241 = arg0.method301();
		this.field2236 = arg0.method301();
		this.field2240 = new class185();
		this.field2243 = new class235();
