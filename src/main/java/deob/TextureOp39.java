...
public class TextureOp39 extends TextureOp {
	...
	public int[][] method7(int arg0) {
		...
		if (super.field364.field4310 && this.method924()) {
			int[] var3 = var2[1];
			int[] var4 = var2[2];
			int var5 = this.field2593 * (this.field2588 == Statics.field460 ? arg0 : this.field2588 * arg0 / Statics.field460);
			int[] var6 = var2[0];
			if (this.field2593 == Statics.field1276) {
				...
				for (int var7 = 0; var7 < Statics.field1276; var7++) {
					int var8 = var7 * this.field2593 / Statics.field1276;
	...
	public final boolean method924() {
		if (this.field2589 != null) {
			...
			SoftwarePix32 var1 = PixLoader.method250(Statics.field684, this.field2592);
			var1.method1178();
