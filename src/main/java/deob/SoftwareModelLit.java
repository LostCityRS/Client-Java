...
public final class SoftwareModelLit extends ModelLit {
		...
		for (int var8 = 0; var8 < this.numFaces; var8++) {
			if (this.faceColourC[var8] != -2) {
				...
				if (arg0 && (var12 == -5000 || var13 == -5000 || var14 == -5000)) {
					...
					if (arg1 && this.method848(class141.field2610 + Pix3D.field3363, Statics.field3604 + Pix3D.field3361, field2300[var9], field2300[var10], field2300[var11], var12, var13, var14)) {
	...
	public SoftwareModelLit method847(int arg0, int arg1, int[][] arg2, int[][] arg3, int arg4, int arg5, int arg6, boolean arg7) {
		if (!this.field2258) {
			this.method844();
		}
	...
	public void method87(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, long arg8) {
		...
		if (arg8 > 0L && Statics.field997 && var14 > 0) {
			...
			if (class141.field2610 >= var29 && class141.field2610 <= var30 && Statics.field3604 >= var31 && Statics.field3604 <= var32) {
				int var33 = 999999;
				int var34 = -999999;
				int var35 = 999999;
				int var36 = -999999;
				...
				if (class141.field2610 >= var33 && class141.field2610 <= var34 && Statics.field3604 >= var35 && Statics.field3604 <= var36) {
					if (super.field494) {
