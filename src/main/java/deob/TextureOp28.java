...
public final class TextureOp28 extends TextureOp {
	...
	public int[] method54(int arg0) {
		...
		boolean var10 = true;
		int var11 = 0;
		int var12 = this.field3637 * Statics.field1276 >> 12;
		int var13 = 0;
		int var14 = this.field3635 * Statics.field1276 >> 12;
		int var15 = Statics.field460 * this.field3634 >> 12;
		int var16 = Statics.field460 * this.field3641 >> 12;
		if (var16 <= 1) {
			return var3[arg0];
		}
		this.field3632 = this.field3624 * (Statics.field1276 / 8) >> 12;
		int var17 = Statics.field1276 / var12 + 1;
		...
		while (true) {
			while (true) {
				...
				if (var22 > Statics.field1276) {
					var22 = Statics.field1276;
					var21 = Statics.field1276 - var7;
				}
				int var27;
				if (var10) {
					var27 = 0;
					...
					if (var28 < 0) {
						var28 += Statics.field1276;
					}
					if (Statics.field1276 < var28) {
						var28 -= Statics.field1276;
					}
					while (true) {
						...
						if (var28 >= var29[0] && var28 <= var29[1]) {
							if (var8 != var24) {
								int var30 = var4 + var7;
								if (var30 < 0) {
									var30 += Statics.field1276;
								}
								if (var30 > Statics.field1276) {
									var30 -= Statics.field1276;
								}
				...
				if (var23 + var27 <= Statics.field460) {
					var9 = false;
				} else {
					var23 = Statics.field460 - var27;
				}
				if (Statics.field1276 == var22) {
					...
					var40[1] = var22;
					var18 = var41;
					var5 = Statics.method812(Statics.field1276, var19);
					var4 = var5 - var6;
					int var42 = var4;
					if (var4 < 0) {
						var42 = var4 + Statics.field1276;
					}
					if (var42 > Statics.field1276) {
						var42 -= Statics.field1276;
					}
					while (true) {
	...
	public void method1308(Random arg0, int[][] arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		if (Statics.field1276 <= arg2) {
			arg2 -= Statics.field1276;
		}
		if (var9 > 0) {
			if (arg5 <= 0 || arg4 <= 0) {
				return;
				...
				if (var16 > var20) {
					...
					if (this.field3642 == 0) {
						for (int var25 = 0; var25 < var17; var25++) {
							...
							var21[arg2 + var25 & Statics.field789] = var21[arg4 + arg2 - var25 - 1 & Statics.field789] = var22 * var26 >> 12;
						}
					} else {
						for (int var23 = 0; var23 < var17; var23++) {
							int var24 = var23 * var7 / var17;
							var21[var23 + arg2 & Statics.field789] = var21[arg2 + arg4 - var23 - 1 & Statics.field789] = var22 <= var24 ? var22 : var24;
						}
					}
					if (Statics.field1276 < var19 + var18) {
						int var27 = Statics.field1276 - var18;
					...
					if (var16 > var28) {
						...
						if (this.field3642 == 0) {
							for (int var32 = 0; var32 < var17; var32++) {
								...
								var21[Statics.field789 & var32 + arg2] = var21[Statics.field789 & arg2 + arg4 - var32 - 1] = var33 * var29 >> 12;
							}
						} else {
							for (int var30 = 0; var30 < var17; var30++) {
								int var31 = var30 * var7 / var17;
								var21[Statics.field789 & var30 + arg2] = var21[Statics.field789 & arg2 + arg4 - var30 - 1] = var29 <= var31 ? var29 : var31;
							}
						}
						if (Statics.field1276 >= var18 + var19) {
							ArrayUtil.method837(var21, var18, var19, var29);
						} else {
							int var34 = Statics.field1276 - var18;
						...
						for (int var35 = 0; var35 < var17; var35++) {
							var21[var35 + arg2 & Statics.field789] = var21[Statics.field789 & arg4 + arg2 - var35 - 1] = var7 * var35 / var17;
						}
						if (var19 + var18 <= Statics.field1276) {
							ArrayUtil.method837(var21, var18, var19, var7);
						} else {
							int var36 = Statics.field1276 - var18;
		...
		} else if (arg4 + arg2 > Statics.field1276) {
			int var10 = Statics.field1276 - arg2;
