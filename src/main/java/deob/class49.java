...
@ObfuscatedName("ia")
public final class class49 extends class44 {
	...
	public static class48 field1328 = new class48(4096);
	...
	public class91 method505(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		long var7;
	...
	public boolean method506() {
		...
		for (int var1 = 0; var1 < this.field1317.length; var1++) {
			if (this.field1317[var1] != -1) {
				class49 var2 = Statics.method389(this.field1317[var1]);
	...
	public void method508(class8 arg0) {
		while (true) {
	...
	public class91 method511(boolean arg0, boolean arg1, int arg2, int arg3) {
		class91 var5 = null;
		if (this.field1305 == null) {
			if (arg3 != 10) {
				return null;
			...
			for (int var8 = 0; var8 < var7; var8++) {
				...
				var5 = (class91) class93.field2322.method263((long) var9);
				if (var5 == null) {
					var5 = class91.method798(Statics.field51, var9 & 0xFFFF);
					if (var5 == null) {
						return null;
					}
					if (var6) {
			...
			if (var7 > 1) {
				var5 = new class91(class104.field2623, var7);
			}
		} else {
			int var10 = -1;
			...
			var5 = (class91) class93.field2322.method263((long) var12);
			if (var5 == null) {
				var5 = class91.method798(Statics.field51, var12 & 0xFFFF);
				if (var5 == null) {
					return null;
				}
				if (var13) {
		...
		class91 var16 = new class91(var5, arg2 == 0 && !var14 && !var15, this.field1299 == null, true);
		int var17 = arg2 & 0x3;
		if (var17 == 1) {
			var16.method781();
		} else if (var17 == 2) {
	...
	public class91 method512(int arg0, int arg1, int arg2, int arg3, int arg4, class47 arg5, int arg6, int arg7) {
		long var9;
		if (this.field1305 == null) {
		...
		class91 var11 = (class91) class99.field2428.method263(var9);
		if (var11 == null) {
	...
	public void method513(class8 arg0, int arg1) {
		if (arg1 == 1) {
			int var11 = arg0.method144();
			if (var11 > 0) {
				if (this.field1308 == null || class75.field1861) {
