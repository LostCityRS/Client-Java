...
@ObfuscatedName("od")
public final class class101 extends class26 {

	@ObfuscatedName("od.ab")
	public byte field2328 = 0;

	@ObfuscatedName("od.ac")
	public static int[] field2380 = class7.field121;
	...
	public static class101 field2331 = new class101();
	...
	public static class101 field2351 = new class101();

	@ObfuscatedName("od.yb")
	public static int[] field2352 = class7.field127;
	...
	@ObfuscatedName("od.Pb")
	public static int[] field2369 = class7.field123;

	@ObfuscatedName("od.Qb")
	public static boolean[] field2370 = new boolean[4096];

	@ObfuscatedName("od.Hb")
	public static int[] field2361 = class7.field113;
	...
	public void method798(int arg0) {
		...
		class7.field117 = field2376[arg0];
		if (this.field2336 == null) {
			class7.field128 = 0;
		} else {
			class7.field128 = this.field2336[arg0] & 0xFF;
		}
		if (this.field2332 != null && this.field2332[arg0] != -1) {
			...
			class7.method38(field2364[var2], field2364[var3], field2364[var4], field2372[var2], field2372[var3], field2372[var4], field2369[this.field2345[arg0]]);
		} else {
			class7.method33(field2364[var2], field2364[var3], field2364[var4], field2372[var2], field2372[var3], field2372[var4], this.field2345[arg0], this.field2327[arg0], this.field2325[arg0]);
		}
	}

	@ObfuscatedName("od.b(Z)Lod;")
	public class101 method799(boolean arg0) {
	...
	public void method184(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
		...
		if (arg8 > 0 && field2373) {
			...
			int var32 = field2362 - class7.field114;
			int var33 = field2363 - class7.field129;
		...
		int var34 = class7.field114;
		int var35 = class7.field129;
		int var36 = 0;
		int var37 = 0;
		if (arg0 != 0) {
	...
	public class101 method800(boolean arg0, class101 arg1, byte[] arg2) {
			...
			if (this.field2325[var5] != -2) {
				...
				if (arg0 && (var9 == -5000 || var10 == -5000 || var11 == -5000)) {
					...
					if ((var9 - var10) * (field2364[var8] - field2364[var7]) - (field2364[var6] - field2364[var7]) * (var11 - var10) > 0) {
						...
						if (var9 >= 0 && var10 >= 0 && var11 >= 0 && var9 <= class7.field130 && var10 <= class7.field130 && var11 <= class7.field130) {
	...
	public class101 method808(int[][] arg0, int arg1, int arg2, int arg3, boolean arg4, int arg5) {
		this.method804();
	...
	public void method809(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		...
		int var8 = class7.field114;
		int var9 = class7.field129;
	...
	public void method810(class121 arg0, int arg1) {
		if (this.field2344 == null || arg1 == -1) {
			return;
		}
		class42 var3 = arg0.field2871[arg1];
		class92 var4 = var3.field974;
		field2366 = 0;
		field2358 = 0;
		field2379 = 0;
	...
	public void method813(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		int var7 = class7.field114;
		int var8 = class7.field129;
	...
	public void method814(class121 arg0, int arg1, class121 arg2, int arg3, int[] arg4) {
		if (arg1 == -1) {
			return;
		}
		if (arg4 == null || arg3 == -1) {
		...
		class42 var6 = arg0.field2871[arg1];
		class42 var7 = arg2.field2871[arg3];
		class92 var8 = var6.field974;
		field2366 = 0;
		field2358 = 0;
		field2379 = 0;
		byte var9 = 0;
	...
	public void method818(int arg0) {
		int var2 = class7.field114;
		int var3 = class7.field129;
		int var4 = 0;
		...
		if (var4 == 3) {
			if (var26 < 0 || var27 < 0 || var28 < 0 || var26 > class7.field130 || var27 > class7.field130 || var28 > class7.field130) {
			...
			if (this.field2332 != null && this.field2332[arg0] != -1) {
				...
				if (this.field2325[arg0] == -1) {
					class7.method39(var29, var30, var31, var26, var27, var28, this.field2345[arg0], this.field2345[arg0], this.field2345[arg0], field2371[var33], field2371[var34], field2371[var35], field2356[var33], field2356[var34], field2356[var35], field2375[var33], field2375[var34], field2375[var35], this.field2332[arg0]);
				} else {
					class7.method39(var29, var30, var31, var26, var27, var28, field2365[0], field2365[1], field2365[2], field2371[var33], field2371[var34], field2371[var35], field2356[var33], field2356[var34], field2356[var35], field2375[var33], field2375[var34], field2375[var35], this.field2332[arg0]);
				}
			} else if (this.field2325[arg0] == -1) {
				class7.method38(var29, var30, var31, var26, var27, var28, field2369[this.field2345[arg0]]);
			} else {
				class7.method33(var29, var30, var31, var26, var27, var28, field2365[0], field2365[1], field2365[2]);
			}
		}
		if (var4 != 4) {
			return;
		}
		if (var26 < 0 || var27 < 0 || var28 < 0 || var26 > class7.field130 || var27 > class7.field130 || var28 > class7.field130 || field2360[3] < 0 || field2360[3] > class7.field130) {
			class7.field117 = true;
		}
		if (this.field2332 == null || this.field2332[arg0] == -1) {
			if (this.field2325[arg0] == -1) {
				int var36 = field2369[this.field2345[arg0]];
				class7.method38(var29, var30, var31, var26, var27, var28, var36);
				class7.method38(var29, var31, field2354[3], var26, var28, field2360[3], var36);
				return;
			}
			class7.method33(var29, var30, var31, var26, var27, var28, field2365[0], field2365[1], field2365[2]);
			class7.method33(var29, var31, field2354[3], var26, var28, field2360[3], field2365[0], field2365[2], field2365[3]);
			return;
		}
		int var38;
		int var39;
		...
		if (this.field2325[arg0] == -1) {
			class7.method39(var29, var30, var31, var26, var27, var28, this.field2345[arg0], this.field2345[arg0], this.field2345[arg0], field2371[var38], field2371[var39], field2371[var40], field2356[var38], field2356[var39], field2356[var40], field2375[var38], field2375[var39], field2375[var40], var41);
			class7.method39(var29, var31, field2354[3], var26, var28, field2360[3], this.field2345[arg0], this.field2345[arg0], this.field2345[arg0], field2371[var38], field2371[var39], field2371[var40], field2356[var38], field2356[var39], field2356[var40], field2375[var38], field2375[var39], field2375[var40], var41);
			return;
		}
		class7.method39(var29, var30, var31, var26, var27, var28, field2365[0], field2365[1], field2365[2], field2371[var38], field2371[var39], field2371[var40], field2356[var38], field2356[var39], field2356[var40], field2375[var38], field2375[var39], field2375[var40], var41);
		class7.method39(var29, var31, field2354[3], var26, var28, field2360[3], field2365[0], field2365[2], field2365[3], field2371[var38], field2371[var39], field2371[var40], field2356[var38], field2356[var39], field2356[var40], field2375[var38], field2375[var39], field2375[var40], var41);
	}
	...
	public class101 method820(boolean arg0) {
