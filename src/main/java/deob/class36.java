...
@ObfuscatedName("f")
public final class class36 extends class146 {
	...
	@ObfuscatedName("f.cc")
	public class36 field824 = null;

	@ObfuscatedName("f.db")
	public int field773 = 0;

	@ObfuscatedName("f.dc")
	public class32 field825 = class128.field2939;

	@ObfuscatedName("f.eb")
	public class32 field774 = class128.field2939;

	@ObfuscatedName("f.ec")
	public static class32 field826 = class73.method593("Please reload this page)3", true);
	...
	@ObfuscatedName("f.kc")
	public static class32[] field832 = new class32[100];

	@ObfuscatedName("f.lc")
	public class32 field833 = class128.field2939;
	...
	@ObfuscatedName("f.vb")
	public class32 field791 = class53.field1202;
	...
	@ObfuscatedName("f.X")
	public static class32 field767 = class73.method593("m", true);

	@ObfuscatedName("f.Jc")
	public static class32 field857 = field826;
	...
	@ObfuscatedName("f.T")
	public class32 field763 = class128.field2939;
	...
	@ObfuscatedName("f.Rb")
	public class32 field813 = class128.field2939;
	...
	@ObfuscatedName("f.z")
	public static class114 field744;
	...
	@ObfuscatedName("f.L")
	public class32[] field756;

	@ObfuscatedName("f.J")
	public class36[] field754;
	...
	public static void method304(int arg0, int arg1, int arg2, int arg3) {
		...
		if (var4 == null) {
			var4 = new class107();
			class34.field709.method1201((long) arg0, var4);
		}
	...
	public static void method305(long arg0) {
		...
		for (int var2 = 0; var2 < class2.field20; var2++) {
			if (class33.field694[var2] == arg0) {
				class2.field20--;
				for (int var3 = var2; var3 < class2.field20; var3++) {
					class14.field239[var3] = class14.field239[var3 + 1];
					class91.field2094[var3] = class91.field2094[var3 + 1];
					class33.field694[var3] = class33.field694[var3 + 1];
					class5.field103[var3] = class5.field103[var3 + 1];
				}
				class2.field26 = class115.field2767;
				class44.field1026.method356(135);
	...
	public static class49 method312(int arg0, class30 arg1, int arg2) {
		return class28.method193(arg2, arg1, arg0) ? class81.method638() : null;
	}

	@ObfuscatedName("f.a(IZ)Lh;")
	public class49 method299(boolean arg0) {
		class125.field2914 = false;
		int var2;
		if (arg0) {
			var2 = this.field844;
		} else {
		...
		class49 var5 = (class49) class85.field1987.method485(var3);
		if (var5 != null) {
			return var5;
		}
		class49 var6 = method312(0, class12.field198, var2);
		if (var6 == null) {
			class125.field2914 = true;
			return null;
		}
		if (this.field814) {
			var6.method380();
		...
		class85.field1987.method484(var3, var6);
		return var6;
	}

	@ObfuscatedName("f.a(Ljd;I)[I")
	public int[] method300(class66 arg0) {
		...
		for (int var4 = 0; var4 < var2; var4++) {
			var3[var4] = arg0.method538();
		}
		return var3;
	}

	@ObfuscatedName("f.a(Lec;ZI)V")
	public void method301(class32 arg0, int arg1) {
		if (this.field738 == null || arg1 >= this.field738.length) {
			class32[] var3 = new class32[arg1 + 1];
	...
	public class96 method302() {
		class125.field2914 = false;
		if (this.field807 == -1) {
			return null;
		}
		class96 var1 = (class96) class45.field1055.method485((long) this.field807);
		if (var1 != null) {
			return var1;
		}
		class96 var2 = class129.method998(this.field807, class4.field57, class12.field198, 0);
		if (var2 == null) {
			class125.field2914 = true;
		} else {
			class45.field1055.method484((long) this.field807, var2);
		}
		return var2;
	}

	@ObfuscatedName("f.a(Lvc;ILeb;IZ)Lod;")
	public class101 method306(class149 arg0, class31 arg1, int arg2, boolean arg3) {
		class125.field2914 = false;
		int var5;
		int var6;
		if (arg3) {
		...
		if (var6 == 0) {
			...
			class101 var7 = (class101) class126.field2922.method485((long) ((var6 << 16) + var5));
			if (var7 == null) {
				if (var6 == 1) {
					class104 var8 = class104.method840(class158.field3635, var5);
					if (var8 == null) {
						class125.field2914 = true;
						return null;
					}
				...
				if (var6 == 2) {
					class104 var9 = class17.method130(var5).method752();
					if (var9 == null) {
						class125.field2914 = true;
						return null;
					}
				...
				if (var6 == 4) {
					class62 var11 = class146.method1092(var5);
					class104 var12 = var11.method482(10);
					if (var12 == null) {
						class125.field2914 = true;
						return null;
					}
				...
				class126.field2922.method484((long) ((var6 << 16) + var5), var7);
			}
			if (arg0 != null) {
	...
	public class49 method307(int arg0) {
		class125.field2914 = false;
		...
		class49 var3 = (class49) class85.field1987.method485((long) var2);
		if (var3 != null) {
			return var3;
		}
		class49 var4 = method312(0, class12.field198, var2);
		if (var4 == null) {
			class125.field2914 = true;
		} else {
			class85.field1987.method484((long) var2, var4);
		}
		return var4;
	}

	@ObfuscatedName("f.b(Ljd;B)V")
	public void method308(class66 arg0) {
		this.field848 = false;
		this.field755 = arg0.method532();
		this.field790 = arg0.method532();
		this.field845 = arg0.method531();
		this.field797 = this.field829 = arg0.method551();
		this.field769 = this.field855 = arg0.method551();
		this.field810 = arg0.method531();
		this.field773 = arg0.method531();
		this.field861 = arg0.method532();
		this.field864 = arg0.method531();
		if (this.field864 == 65535) {
			this.field864 = -1;
		} else {
			this.field864 += this.field743 & 0xFFFF0000;
		}
		this.field752 = arg0.method531();
		...
		if (var2 > 0) {
			...
			for (int var3 = 0; var3 < var2; var3++) {
				this.field778[var3] = arg0.method532();
				this.field785[var3] = arg0.method531();
			}
		}
		...
		if (var4 > 0) {
			...
			for (int var5 = 0; var5 < var4; var5++) {
				int var6 = arg0.method531();
				this.field842[var5] = new int[var6];
				for (int var7 = 0; var7 < var6; var7++) {
					this.field842[var5][var7] = arg0.method531();
		...
		if (this.field755 == 0) {
			this.field820 = arg0.method531();
			this.field740 = arg0.method532() == 1;
		}
		if (this.field755 == 1) {
			arg0.method531();
			arg0.method532();
		...
		if (this.field755 == 2) {
			this.field753 = new int[this.field810 * this.field773];
			this.field834 = new int[this.field773 * this.field810];
		...
		if (this.field755 == 3) {
			this.field803 = arg0.method532() == 1;
		}
		if (this.field755 == 4 || this.field755 == 1) {
			this.field841 = arg0.method532();
			this.field799 = arg0.method532();
			this.field838 = arg0.method532();
			this.field807 = arg0.method531();
			if (this.field807 == 65535) {
				this.field807 = -1;
			}
			this.field856 = arg0.method532() == 1;
		}
		if (this.field755 == 4) {
		...
		if (this.field755 == 1 || this.field755 == 3 || this.field755 == 4) {
			this.field776 = arg0.method538();
		}
		if (this.field755 == 3 || this.field755 == 4) {
			this.field869 = arg0.method538();
			this.field830 = arg0.method538();
			this.field783 = arg0.method538();
		}
		if (this.field755 == 5) {
			this.field819 = arg0.method538();
			this.field844 = arg0.method538();
		}
		if (this.field755 == 6) {
			this.field770 = 1;
			this.field849 = arg0.method531();
			this.field798 = 1;
			if (this.field849 == 65535) {
				this.field849 = -1;
			}
			this.field811 = arg0.method531();
			if (this.field811 == 65535) {
				this.field811 = -1;
			}
			this.field765 = arg0.method531();
			if (this.field765 == 65535) {
				this.field765 = -1;
			}
			this.field787 = arg0.method531();
			if (this.field787 == 65535) {
				this.field787 = -1;
			}
			this.field808 = arg0.method531();
			this.field812 = arg0.method531();
			this.field874 = arg0.method531();
		}
		if (this.field755 == 7) {
			this.field834 = new int[this.field773 * this.field810];
			this.field753 = new int[this.field773 * this.field810];
			this.field841 = arg0.method532();
			this.field807 = arg0.method531();
			if (this.field807 == 65535) {
				this.field807 = -1;
			...
			int var16 = arg0.method532();
			this.field756 = new class32[5];
			if (var16 == 1) {
				this.field768 |= 0x40000000;
			}
			for (int var17 = 0; var17 < 5; var17++) {
				class32 var18 = arg0.method555();
				if (var18.method240() > 0) {
		...
		if (this.field790 == 2 || this.field755 == 2) {
			...
			int var19 = arg0.method531() & 0x3F;
			this.field768 |= var19 << 11;
		}
		if (this.field790 == 1 || this.field790 == 4 || this.field790 == 5 || this.field790 == 6) {
			this.field791 = arg0.method555();
			if (this.field791.method240() == 0) {
				if (this.field790 == 1) {
					this.field791 = class53.field1202;
				}
				if (this.field790 == 4) {
					this.field791 = class61.field1365;
				}
				if (this.field790 == 5) {
					this.field791 = class61.field1365;
				}
				if (this.field790 == 6) {
					this.field791 = class86.field2002;
				}
			}
		}
	...
	public Object[] method310(class66 arg0) {
		int var2 = arg0.method532();
		if (var2 == 0) {
			return null;
		}
		...
		for (int var4 = 0; var4 < var2; var4++) {
			...
			if (var5 == 0) {
				var3[var4] = Integer.valueOf(arg0.method538());
			} else if (var5 == 1) {
	...
	public void method311(class66 arg0) {
		arg0.method532();
		this.field848 = true;
		this.field755 = arg0.method532();
		this.field845 = arg0.method531();
		...
		this.field740 = arg0.method532() == 1;
		if (this.field755 == 0) {
			this.field860 = arg0.method531();
			this.field820 = arg0.method531();
		}
		if (this.field755 == 5) {
			this.field819 = arg0.method538();
			this.field777 = arg0.method531();
			this.field748 = arg0.method532() == 1;
			this.field861 = arg0.method532();
			this.field796 = arg0.method532();
			this.field817 = arg0.method538();
			this.field814 = arg0.method532() == 1;
			this.field772 = arg0.method532() == 1;
		}
		if (this.field755 == 6) {
			this.field770 = 1;
			this.field849 = arg0.method531();
			...
			this.field812 = arg0.method531();
			this.field874 = arg0.method531();
			this.field750 = arg0.method531();
			this.field808 = arg0.method531();
			this.field765 = arg0.method531();
			if (this.field765 == 65535) {
				this.field765 = -1;
			}
			this.field853 = arg0.method532() == 1;
		}
		if (this.field755 == 4) {
			this.field807 = arg0.method531();
			if (this.field807 == 65535) {
		...
		if (this.field755 == 9) {
			this.field788 = arg0.method532();
			this.field776 = arg0.method538();
		}
		this.field768 = arg0.method517();
		this.field813 = arg0.method555();
		int var2 = arg0.method532();
		if (var2 > 0) {
			this.field738 = new class32[var2];
			for (int var3 = 0; var3 < var2; var3++) {
				this.field738[var3] = arg0.method555();
			}
		}
		this.field760 = arg0.method532();
		this.field746 = arg0.method532();
		this.field862 = arg0.method532() == 1;
		this.field825 = arg0.method555();
