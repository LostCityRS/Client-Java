						...
						if (var34 >= 1 && var34 < 103 && (!Client.lowMem || (mapl[0][var21][var34] & 0x2) != 0 || (mapl[var6][var21][var34] & 0x10) == 0 && method964(var6, var34, var21) == field1472)) {
							...
							if (var37 > 0 || var38 > 0) {
								...
								if (var6 > 0) {
									...
									if (var38 > 0 && !FloType.method1026(var38 - 1).field913) {
										var54 = false;
									}
								...
								if (var38 == 0) {
									...
									FloType var58 = FloType.method1026(var38 - 1);
	...
	public static void method301(int arg0, CollisionMap arg1, int arg2, World arg3, int arg4, int arg5, int arg6, int arg7) {
		...
		if (arg4 == 22) {
			...
			if (var17 != null) {
				...
				if (arg3.addScenery(arg7, arg2, arg6, var14, var18, var19, var17, var20, var12, var13) && var15.field1324) {
					Model var21;
