...
public final class Client extends GameShell {
	...
	public static void gameDrawMain() {
		...
		if (!cinemaCam) {
			...
			method848(var0, field1194, getAvH(minusedlevel, localPlayer.x, localPlayer.z) - 50, var1, field1839, var0 * 3 + 600);
		}
		int var2;
		if (cinemaCam) {
			var2 = method273();
		...
		entityOverlays();
		method578();
		((TextureManager) Pix3D.textureManager).method697(worldUpdateNum);
		otherOverlays();
			...
			if (minusedlevel != var0.field638 || loopCycle > var0.field628) {
				...
				if (var0.field618 > 0) {
					...
					if (var1 != null && var1.x >= 0 && var1.x < 13312 && var1.z >= 0 && var1.z < 13312) {
						var0.method300(loopCycle, var1.z, getAvH(var0.field638, var1.x, var1.z) - var0.field617, var1.x);
					}
				}
				if (var0.field618 < 0) {
					...
					if (var3 != null && var3.x >= 0 && var3.x < 13312 && var3.z >= 0 && var3.z < 13312) {
						var0.method300(loopCycle, var3.z, getAvH(var0.field638, var3.x, var3.z) - var0.field617, var3.x);
					}
				}
	...
	public static void entityOverlays() {
		...
		for (int var8 = 0; var8 < chatCount; var8++) {
			...
			if (chatEffects == 0) {
				...
				if (field1670[var8] == 1) {
					b12.centreStringWave(var15, field1072, field2188 + 1, 0, sceneCycle);
					b12.centreStringWave(var15, field1072, field2188, var16, sceneCycle);
				}
				if (field1670[var8] == 2) {
					b12.centreStringWave2(var15, field1072, field2188 + 1, 0, sceneCycle);
					b12.centreStringWave2(var15, field1072, field2188, var16, sceneCycle);
				}
				if (field1670[var8] == 3) {
					b12.centreStringWave3(var15, field1072, field2188 + 1, 0, sceneCycle, 150 - field1659[var8]);
					b12.centreStringWave3(var15, field1072, field2188, var16, sceneCycle, 150 - field1659[var8]);
				}
				if (field1670[var8] == 4) {
	...
	public static void getPlayerPosExtended(ClientPlayer arg0, int arg1, int arg2) {
		...
		if ((arg1 & 0x8) != 0) {
			...
			int var12 = in.pos;
			if (arg0.field86 != null && arg0.model != null) {
				...
				if (!var15 && chatDisabled == 0) {
					...
					if (var10 == 2 || var10 == 3) {
						addChat(1, var17, JagString.join(new JagString[]{field2535, arg0.field86}));
					} else if (var10 == 1) {
						addChat(1, var17, JagString.join(new JagString[]{field2612, arg0.field86}));
					} else {
						addChat(2, var17, arg0.field86);
					}
				}
			}
			in.pos = var11 + var12;
		...
		if (arg0.chat.method6(0) == 126) {
			...
			addChat(2, arg0.chat, arg0.field86);
			...
			if (var11 != null && var11.layerId == arg4) {
				...
				if (!var11.v3 || Pix2D.field2753 >= var12 && Pix2D.field2751 >= var13 && Pix2D.field2752 <= var11.width + var12 && var13 + var11.height >= Pix2D.field2748) {
					if (var11.type == 0) {
						...
						var9 &= method278(arg0, var13, var12, var11.scrollPosX, var10, var11.height + var13, var11.width + var12, var11.scrollPosY, arg8);
						if (var11.subcomponents != null) {
							var9 &= method278(arg0, var13, var12, var11.scrollPosX, var11.parentId, var13 + var11.height, var11.width + var12, var11.scrollPosY, var11.subcomponents);
						}
						Pix2D.setSubClipping(arg2, arg1, arg6, arg5);
								...
								for (int var22 = 0; var22 < var11.width; var22++) {
									...
									if (var11.linkObjType[var20] > 0) {
										...
										if (Pix2D.field2752 - 32 < var23 && var23 < Pix2D.field2753 && Pix2D.field2748 - 32 < var24 && Pix2D.field2751 > var24 || objDragArea != 0 && objDragSlot == var20) {
											int var29 = 0;
											if (useMode == 1 && field2281 == var20 && field1075 == var11.parentId) {
												var29 = 16777215;
											}
											...
											if (var30 == null) {
												...
												if (objDragArea != 0 && objDragSlot == var20 && objDragComId == var11.parentId) {
													...
													if (arg4 != -1) {
														...
														if (var24 + var28 < Pix2D.field2748 && var31.scrollPosY > 0) {
														...
														if (Pix2D.field2751 < var24 + var28 + 32 && var31.scrollPosY < var31.scrollPos - var31.height) {
				...
				for (int var8 = 0; var8 < field1492; var8++) {
					if (field2929[var8] == var4) {
						if (field1788[var8] != var6) {
							...
							redrawSide = true;
							if (var6 > 0) {
								addChat(5, JagString.join(new JagString[]{var7, Text.field2126}), field3234);
							}
							if (var6 == 0) {
								addChat(5, JagString.join(new JagString[]{var7, Text.field1510}), field3234);
							}
						}
						var7 = null;
						break;
			...
			if (var4 != null && var4.ready()) {
				...
				if (var5 >= 0 && var5 < 104 && var6 >= 0 && var6 < 104) {
					if (var4.field73 == null || var4.field91 > loopCycle || loopCycle >= var4.field82) {
						...
						world.addDynamic(minusedlevel, var4.x, var4.z, var4.field84, 60, var4, var4.yaw, var3, var4.field1979);
					} else {
						var4.field95 = false;
						var4.field84 = getAvH(minusedlevel, var4.x, var4.z);
		...
		for (int var1 = 0; var1 < npcCount; var1++) {
			...
			if (var2 != null && var2.ready() && arg0 == var2.type.alwaysontop && var2.type.isMultiNpcVisible()) {
				...
				if (var4 >= 0 && var4 < 104 && var5 >= 0 && var5 < 104) {
					...
					world.addDynamic(minusedlevel, var2.x, var2.z, getAvH(minusedlevel, (var2.size - 1) * 64 + var2.x, var2.size * 64 + var2.z + -64), var2.size * 64 + 60 - 64, var2, var2.yaw, var3, var2.field1979);
				}
			}
		}
	}
	...
	public static void method272(int arg0, int arg1, ClientPlayer arg2, int arg3) {
		...
		JagString var4;
		if (arg2.field65 == 0) {
			var4 = JagString.join(new JagString[]{arg2.field86, combatColourCode(localPlayer.combatLevel, arg2.combatLevel), field1275, Text.field785, JagString.parseInt(arg2.combatLevel), field2601});
		} else {
	...
	public static void method1019() {
		...
		if (useMode == 0 && targetMode == 0) {
			addMenuOption(0, Text.field3057, ClientMouseListener.mouseY, ClientMouseListener.mouseX, 7, field3234);
		}
	...
	public static void doAction(int arg0) {
		...
		if (var3 == 26 || var3 == 46) {
			...
			if (var9 != -1) {
				...
				if (!var12) {
					addChat(0, JagString.join(new JagString[]{Text.field718, var11}), field3234);
				}
			}
		}
		if (var3 == 55) {
		...
		if (var3 == 1007) {
			...
			if (var36 == null || var36.field2540 < 100000) {
				...
				addChat(0, JagString.join(new JagString[]{JagString.parseInt(var36.field2540), field3203, ObjType.list(var4).name}), field3234);
			}
		}
		if (var3 == 42) {
		...
		if (var3 == 1006) {
			...
			if (var50 == null || var50.linkObjNumber[var1] < 100000) {
				...
				addChat(0, JagString.join(new JagString[]{JagString.parseInt(var50.linkObjNumber[var1]), field3203, ObjType.list(var4).name}), field3234);
			}
			field2649 = var1;
			selectedCycle = 0;
			field1679 = var2;
		...
		if (var3 == 28) {
			...
			if (var53 != -1) {
				if (field3227 == -1) {
					...
					addChat(0, Text.field1921, field3234);
				}
			}
		}
		if (var3 == 8) {
			...
			if (var12 != null && var12.layerId == arg5) {
				...
				if (var12.type != 0) {
					if (var12.buttonType == 1 && var14 <= arg7 && var13 <= arg4 && var12.width + var14 > arg7 && var12.height + var13 > arg4) {
						...
						if (!var15) {
							addMenuOption(0, var12.buttonText, var12.parentId, 0, 42, field3234);
						}
					}
	...
	public static void method383(long arg0) {
		...
		if (field2146 >= 100) {
			addChat(0, Text.field2582, field3234);
			return;
		}
		JagString var2 = JString.method969(arg0).method36();
		for (int var3 = 0; var3 < field2146; var3++) {
			if (field2683[var3] == arg0) {
				addChat(0, JagString.join(new JagString[]{var2, Text.field3295}), field3234);
				return;
			}
		}
		for (int var4 = 0; var4 < field1492; var4++) {
			if (field2929[var4] == arg0) {
				addChat(0, JagString.join(new JagString[]{Text.field2172, var2, Text.field3138}), field3234);
				return;
			}
		}
	...
	public static void method703(long arg0) {
		...
		if (field1492 >= 100 && membersAccount != 1 || field1492 >= 200) {
			addChat(0, Text.field2931, field3234);
			return;
		}
		JagString var2 = JString.method969(arg0).method36();
		for (int var3 = 0; var3 < field1492; var3++) {
			if (field2929[var3] == arg0) {
				addChat(0, JagString.join(new JagString[]{var2, Text.field3045}), field3234);
				return;
			}
		}
		for (int var4 = 0; var4 < field2146; var4++) {
			if (field2683[var4] == arg0) {
				addChat(0, JagString.join(new JagString[]{Text.field2178, var2, Text.field2054}), field3234);
				return;
			}
		}
		if (var2.strEquals(localPlayer.field86)) {
