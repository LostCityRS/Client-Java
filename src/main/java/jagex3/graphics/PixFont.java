...
public final class PixFont extends Pix2D {
	...
	public int updateState(JagString arg0) {
	...
	public void drawStringMultiline(JagString arg0, int arg1, int arg2, int arg3, int arg4, int arg5, boolean arg6, int arg7, int arg8, int arg9) {
		...
		for (int var20 = 0; var20 < var19; var20++) {
			int var21 = arg0.charAt(var20);
			if (var21 == 64 && var20 + 4 < var19 && arg0.charAt(var20 + 4) == 64) {
	...
	public void centreStringWave(JagString arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		int var6 = arg1 - this.stringWid(arg0) / 2;
		int var7 = arg2 - this.ascent;
	...
	public void centreStringWave3(JagString arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		int var9 = arg1 - this.stringWid(arg0) / 2;
		int var10 = arg2 - this.ascent;
	...
	public void method203(JagString arg0, int arg1, int arg2, int arg3, boolean arg4, int arg5) {
		...
		if (this.strikeout) {
			Pix2D.hline(var12, (int) ((double) this.ascent * 0.7D) + var13, arg1 - var12, 8388608);
		}
	}
	...
	public int stringWidTag(JagString arg0) {
		...
		for (int var3 = 0; var3 < arg0.length; var3++) {
			if (arg0.charCode[var3] == 64 && var3 + 4 < arg0.length && arg0.charCode[var3 + 4] == 64) {
				var3 += 4;
			} else {
				var2 += this.charAdvance[arg0.charCode[var3] & 0xFF];
			}
		}
		return var2;
	}
	...
	public void drawString(JagString arg0, int arg1, int arg2, int arg3, boolean arg4) {
		...
		if (this.strikeout) {
			Pix2D.hline(var6, (int) ((double) this.ascent * 0.7D) + var7, arg1 - var6, 8388608);
		}
	}

	@ObfuscatedName("bc.b(La;IIIZI)V")
	public void drawStringAntiMacro(JagString arg0, int arg1, int arg2, int arg3) {
		if (arg0 == null) {
			return;
		}
		this.rand.setSeed((long) arg3);
		int var5 = (this.rand.nextInt() & 0x1F) + 192;
		int var6 = 15 - this.ascent;
	...
	public void method210(JagString arg0, int arg1, int arg2) {
		this.drawString(arg0, 507 - this.stringWid(arg0), arg1, arg2);
	}
