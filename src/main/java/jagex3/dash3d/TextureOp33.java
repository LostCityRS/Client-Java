...
public final class TextureOp33 extends TextureOp {
	...
	public int[][] method7(int arg0) {
		...
		if (super.field364.field4310) {
			int[] var3 = this.method120(Texture.field4158 & arg0 - 1, 0);
			int[] var4 = this.method120(arg0, 0);
			int[] var5 = this.method120(arg0 + 1 & Texture.field4158, 0);
			int[] var6 = var2[0];
			int[] var7 = var2[2];
			int[] var8 = var2[1];
			for (int var9 = 0; var9 < Texture.field1276; var9++) {
				int var10 = (var5[var9] - var3[var9]) * this.field17;
				int var11 = (var4[var9 + 1 & Texture.field789] - var4[var9 - 1 & Texture.field789]) * this.field17;
				int var12 = var11 >> 12;
				int var13 = var10 >> 12;
