...
public final class TextureOp36 extends TextureOp {
	...
	public int[][] method7(int arg0) {
		...
		if (super.field364.field4310 && this.method1361()) {
			int var3 = this.field3752 * (Texture.field460 == this.field3751 ? arg0 : arg0 * this.field3751 / Texture.field460);
			int[] var4 = var2[0];
			int[] var5 = var2[1];
			int[] var6 = var2[2];
			if (Texture.field1276 == this.field3752) {
				...
				for (int var7 = 0; var7 < Texture.field1276; var7++) {
					int var8 = this.field3752 * var7 / Texture.field1276;
