	...
	public int[] renderMono(int arg0) {
		...
		if (super.monoCache.field3098) {
			...
			for (int var5 = 0; var5 < Texture.field1276; var5++) {
				...
				int var10 = var5 + (var8 >> 12) & Texture.field789;
				int var11 = Texture.field4158 & (var9 >> 12) + arg0;
	...
	public int[][] renderColor(int arg0) {
		...
		if (super.colorCache.field4310) {
			...
			for (int var8 = 0; var8 < Texture.field1276; var8++) {
				...
				int var13 = var8 + (var11 >> 12) & Texture.field789;
				int var14 = arg0 + (var12 >> 12) & Texture.field4158;
