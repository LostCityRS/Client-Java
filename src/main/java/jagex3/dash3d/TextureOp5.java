	...
	public int[] method54(int arg0) {
		...
		if (super.field379.field3098) {
			...
			for (int var8 = arg0 - this.field1753; var8 <= arg0 + this.field1753; var8++) {
				int[] var9 = this.method120(Texture.field4158 & var8, 0);
				...
				while (Texture.field1276 > var13) {
					...
					int var14 = var11 - var9[var13 - this.field1758 & Texture.field789];
					var13++;
					var11 = var14 + var9[Texture.field789 & var13 + this.field1758];
				}
	...
	public int[][] method7(int arg0) {
		...
		if (super.field364.field4310) {
			...
			for (int var8 = arg0 - this.field1753; var8 <= arg0 + this.field1753; var8++) {
				int var9 = 0;
				int var10 = 0;
				int[][] var11 = this.method121(0, Texture.field4158 & var8);
				int var12 = 0;
				...
				while (Texture.field1276 > var22) {
					...
					int var23 = var22 - this.field1758 & Texture.field789;
					int var24 = var12 - var14[var23];
					int var25 = var9 - var15[var23];
					int var26 = var10 - var16[var23];
					var22++;
					int var27 = Texture.field789 & this.field1758 + var22;
