...
public final class TextureOp9 extends TextureOp {
	...
	public int[][] method7(int arg0) {
		...
		if (super.field364.field4310) {
			int[][] var3 = this.method121(0, this.field1088 ? Texture.field4158 - arg0 : arg0);
			int[] var4 = var3[0];
			int[] var5 = var3[2];
			int[] var6 = var3[1];
			int[] var7 = var2[0];
			...
			if (this.field1089) {
				for (int var11 = 0; var11 < Texture.field1276; var11++) {
					var7[var11] = var4[Texture.field789 - var11];
					var8[var11] = var6[Texture.field789 - var11];
					var9[var11] = var5[Texture.field789 - var11];
				}
			} else {
	...
	public int[] method54(int arg0) {
		...
		if (super.field379.field3098) {
			int[] var3 = this.method120(this.field1088 ? Texture.field4158 - arg0 : arg0, 0);
			if (this.field1089) {
				for (int var4 = 0; var4 < Texture.field1276; var4++) {
					var2[var4] = var3[Texture.field789 - var4];
				}
			} else {
				ArrayUtil.method838(var3, 0, var2, 0, Texture.field1276);
			}
		}
		return var2;
	}
