...
public final class TextureOpPixelate extends TextureOp {
	...
	public int[] renderMono(int arg0) {
		...
		if (super.monoCache.field3098) {
			int var3 = Texture.field1276 / this.pixelSizeX;
			int var4 = Texture.field460 / this.pixelSizeY;
			int[] var6;
			if (var4 > 0) {
				int var5 = arg0 % var4;
				var6 = this.getInputMono(var5 * Texture.field460 / var4, 0);
			} else {
	...
	public int[][] renderColor(int arg0) {
		...
		if (super.colorCache.field4310) {
			int var3 = Texture.field460 / this.pixelSizeY;
			int var4 = Texture.field1276 / this.pixelSizeX;
			int[][] var6;
			if (var3 > 0) {
				int var5 = arg0 % var3;
				var6 = this.getInputColor(0, Texture.field460 * var5 / var3);
			} else {
