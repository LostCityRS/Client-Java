...
public final class ModelUnlit extends ModelSource {
	...
	@ObfuscatedName("he.J")
	public PointNormal[] field1497;

	@ObfuscatedName("he.Y")
	public FaceNormal[] field1512;

	@ObfuscatedName("he.C")
	public PointNormal[] field1490;
	...
	public void method548() {
		...
		this.field1497 = new PointNormal[this.field1489];
		for (int var1 = 0; var1 < this.field1489; var1++) {
			this.field1497[var1] = new PointNormal();
		}
		for (int var2 = 0; var2 < this.field1485; var2++) {
			...
			if (var19 == 0) {
				...
				if (this.field1512 == null) {
					this.field1512 = new FaceNormal[this.field1485];
				}
				FaceNormal var23 = this.field1512[var2] = new FaceNormal();
	...
	public void method556(byte[] arg0) {
		...
		for (int var69 = 0; var69 < var10; var69++) {
			...
			if (var12 == 1) {
				this.field1480[var69] = var3.g1b();
			}
			if (var13 == 255) {
				this.field1493[var69] = var4.g1b();
			}
			if (var14 == 1) {
				this.field1510[var69] = var5.g1b();
			}
			if (var15 == 1) {
		...
		for (int var77 = 0; var77 < var11; var77++) {
			...
			if (var78 == 1) {
				...
				this.field1478[var77] = var5.g1b();
				this.field1517[var77] = var6.g1b();
				this.field1516[var77] = var7.g1b();
			}
			if (var78 == 2) {
				this.field1501[var77] = (short) var3.g2();
				this.field1495[var77] = (short) var3.g2();
	...
	public void method570(ModelSource arg0, int arg1, int arg2, int arg3, boolean arg4) {
		...
		for (int var10 = 0; var10 < this.field1489; var10++) {
			PointNormal var11 = this.field1497[var10];
					...
					if (var13 >= var6.field1515 && var13 <= var6.field1520) {
						...
						if (var14 >= var6.field1504 && var14 <= var6.field1479) {
							for (int var15 = 0; var15 < var9; var15++) {
								PointNormal var16 = var6.field1497[var15];
								if (var13 == var8[var15] && var14 == var6.field1506[var15] && var12 == var6.field1476[var15] && var16.field1738 != 0) {
									if (this.field1490 == null) {
										this.field1490 = new PointNormal[this.field1489];
									}
									if (var6.field1490 == null) {
										var6.field1490 = new PointNormal[var9];
									}
									PointNormal var17 = this.field1490[var10];
									if (var17 == null) {
										var17 = this.field1490[var10] = new PointNormal(var11);
									}
									PointNormal var18 = var6.field1490[var15];
									if (var18 == null) {
										var18 = var6.field1490[var15] = new PointNormal(var16);
									}
	...
	public void method571(byte[] arg0) {
		...
		for (int var48 = 0; var48 < var10; var48++) {
			...
			if (var13 == 255) {
				this.field1493[var48] = var6.g1b();
			}
			if (var14 == 1) {
				this.field1510[var48] = var7.g1b();
			}
			if (var15 == 1) {
