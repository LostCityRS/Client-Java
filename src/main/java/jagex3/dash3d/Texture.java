...
public final class Texture extends Linkable {
	...
	public void animate(int arg0) {
		...
		if (this.animationDirection == 1 || this.animationDirection == 3) {
			...
			short var2;
			if (this.texels.length == 16384) {
				var2 = 64;
			} else {
				var2 = 128;
			}
			int var3 = this.texels.length / 4;
			...
			for (int var6 = 0; var6 < var3; var6++) {
				...
				swapBuffer[var3 + var6] = this.texels[var3 + var7];
				swapBuffer[var3 + var6 + var3] = this.texels[var3 + var7 + var3];
				swapBuffer[var3 + var6 + var3 + var3] = this.texels[var3 + var7 + var3 + var3];
			}
		...
		int var10 = this.texels.length / 4;
		...
		for (int var13 = 0; var13 < var10; var13 += var9) {
			for (int var14 = 0; var14 < var9; var14++) {
				...
				swapBuffer[var10 + var15] = this.texels[var10 + var16];
				swapBuffer[var10 + var15 + var10] = this.texels[var10 + var16 + var10];
				swapBuffer[var10 + var15 + var10 + var10] = this.texels[var10 + var16 + var10 + var10];
			}
		}
	...
	public boolean loadTexture(double arg0, int arg1, Js5 arg2) {
		...
		for (int var26 = 0; var26 < var6; var26++) {
			this.texels[var26] &= 0xF8F8FF;
			int var27 = this.texels[var26];
			this.texels[var6 + var26] = var27 - (var27 >>> 3) & 0xF8F8FF;
			this.texels[var6 + var26 + var6] = var27 - (var27 >>> 2) & 0xF8F8FF;
			this.texels[var6 + var26 + var6 + var6] = var27 - (var27 >>> 2) - (var27 >>> 3) & 0xF8F8FF;
		}
		return true;
	}
