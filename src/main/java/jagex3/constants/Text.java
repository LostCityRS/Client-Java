...
public class Text {
	...
	@ObfuscatedName("o.wb")
	public static JagString field2226 = field2242;

	@ObfuscatedName("fe.S")
	public static JagString field971 = JagString.wrap(" has logged in)3");
	@ObfuscatedName("fe.K")
	...
	@ObfuscatedName("ad.o")
	public static JagString field97 = field91;
	@ObfuscatedName("ad.m")
	...
	@ObfuscatedName("ac.U")
	public static JagString SELECTAWORLD = AUTO_SELECTAWORLD;

	@ObfuscatedName("pa.q")
	public static JagString AUTO_MEMBERSONLYWORLD = JagString.wrap("Members only world");
	@ObfuscatedName("pa.d")
	...
	@ObfuscatedName("na.r")
	public static JagString SL_PLAYERS = AUTO_SL_PLAYERS;

	@ObfuscatedName("ee.ib")
	public static JagString AUTO_SL_LOCATION = JagString.wrap("Location");
	@ObfuscatedName("ee.cb")
	public static JagString SL_LOCATION = AUTO_SL_LOCATION;

	@ObfuscatedName("qa.m")
	public static JagString AUTO_SL_TYPE = JagString.wrap("Type");
	@ObfuscatedName("qa.h")
	public static JagString SL_TYPE = AUTO_SL_TYPE;

	@ObfuscatedName("ee.jb")
	public static JagString AUTO_OFFLINEWORLD = JagString.wrap("OFF");
	@ObfuscatedName("ee.W")
	public static JagString OFFLINEWORLD = AUTO_OFFLINEWORLD;

	@ObfuscatedName("rf.a")
	public static JagString AUTO_FULLWORLD = JagString.wrap("FULL");
	@ObfuscatedName("rf.h")
	public static JagString FULLWORLD = AUTO_FULLWORLD;

	@ObfuscatedName("kc.h")
	public static JagString AUTO_LOADINGDOTDOTDOT = JagString.wrap("Loading)3)3)3");
	@ObfuscatedName("kc.t")
	public static JagString LOADINGDOTDOTDOT = AUTO_LOADINGDOTDOTDOT;

	@ObfuscatedName("kb.t")
	public static JagString AUTO_CLICKTOSWITCH = JagString.wrap("Click to switch");
	@ObfuscatedName("kb.e")
	public static JagString CLICKTOSWITCH = AUTO_CLICKTOSWITCH;
}
