		...
		for (int var4 = 0; var4 < var3.field535; var4++) {
			try {
				...
				if (var5 == 0 || var5 == 1 || var5 == 2) {
					String var16 = new String(arg1.gjstr().copy());
					String var17 = new String(arg1.gjstr().copy());
					int var18 = 0;
					if (var5 == 1) {
						var18 = arg1.g4();
					}
					...
					String var6 = new String(arg1.gjstr().copy());
					String var7 = new String(arg1.gjstr().copy());
					int var8 = arg1.g1();
					String[] var9 = new String[var8];
					for (int var10 = 0; var10 < var8; var10++) {
						var9[var10] = new String(arg1.gjstr().copy());
					}
