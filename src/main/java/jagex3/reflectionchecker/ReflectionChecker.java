		...
		for (int var4 = 0; var4 < var3.size; var4++) {
			try {
				...
				if (var5 == 0 || var5 == 1 || var5 == 2) {
					int var16 = 0;
					String var17 = new String(arg1.gjstr().getBytes());
					String var18 = new String(arg1.gjstr().getBytes());
					if (var5 == 1) {
						var16 = arg1.g4();
					}
					var3.type[var4] = var5;
					var3.fieldValue[var4] = var16;
					var3.field[var4] = arg0.getDeclaredField(findClass(var17), var18);
				} else if (var5 == 3 || var5 == 4) {
					String var6 = new String(arg1.gjstr().getBytes());
					String var7 = new String(arg1.gjstr().getBytes());
					int var8 = arg1.g1();
					String[] var9 = new String[var8];
					for (int var10 = 0; var10 < var8; var10++) {
						var9[var10] = new String(arg1.gjstr().getBytes());
					}
					...
					var3.method[var4] = arg0.getDeclaredMethod(var14, var7, findClass(var6));
				...
				if (var1.error[var5] == 0) {
					try {
						...
						if (var6 == 0) {
							...
							var9.setInt(null, var1.fieldValue[var5]);
							arg0.p1(0);
						} else if (var6 == 2) {
							Field var10 = (Field) var1.field[var5].result;
