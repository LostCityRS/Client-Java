...
public final class SeqType extends Linkable2 {
	...
	public ModelLit method1109(int arg0, int arg1, ModelLit arg2) {
		...
		int var7 = arg0 & 0x3;
		ModelLit var8 = arg2.method799(!var5.getAnimateTransparencies(var6));
		if (var7 == 1) {
			var8.method812();
		} else if (var7 == 2) {
			var8.method803();
	...
	public ModelLit method1111(ModelLit arg0, int arg1) {
		...
		if (var4 == null) {
			...
			ModelLit var6 = arg0.method820(!var4.getAnimateTransparencies(var5));
	...
	public ModelLit method1113(int arg0, ModelLit arg1) {
		...
		if (var6 == null || var7 == 65535) {
			ModelLit var9 = arg1.method799(!var4.getAnimateTransparencies(var5));
			var9.method810(var4, var5);
			return var9;
		} else {
			ModelLit var10 = arg1.method799(!var4.getAnimateTransparencies(var5) & !var6.getAnimateTransparencies(var7));
	...
	public ModelLit splitAnimateModel(int arg0, SeqType arg1, ModelLit arg2, int arg3) {
		...
		if (var9 == null) {
			ModelLit var11 = arg2.method799(!var6.getAnimateTransparencies(var7));
			var11.method810(var6, var7);
			return var11;
		} else {
			ModelLit var12 = arg2.method799(!var6.getAnimateTransparencies(var7) & !var9.getAnimateTransparencies(var10));
	...
	public ModelLit animateModel(ModelLit arg0, int arg1) {
		...
		if (var4 == null) {
			...
			ModelLit var6 = arg0.method799(!var4.getAnimateTransparencies(var5));
			var6.method810(var4, var5);
			return var6;
		}
	}
