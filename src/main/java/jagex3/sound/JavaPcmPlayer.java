...
public final class JavaPcmPlayer extends PcmPlayer {
	...
	public void method141(Component arg0) {
		this.field2025 = new AudioFormat((float) PcmPlayer.frequency, 16, field1310 ? 2 : 1, true, false);
		this.field2024 = new byte[0x100 << (field1310 ? 2 : 1)];
	}
	...
	public void method143(int arg0) throws LineUnavailableException {
		try {
			Info var2 = new Info(SourceDataLine.class, this.field2025, arg0 << (field1310 ? 2 : 1));
			this.field2026 = (SourceDataLine) AudioSystem.getLine(var2);
			this.field2026.open();
			this.field2026.start();
			this.field2027 = arg0;
		} catch (LineUnavailableException var4) {
			if (MathTool.method959(arg0) == 1) {
				this.field2026 = null;
				throw var4;
			} else {
	...
	public int method138() {
		return this.field2027 - (this.field2026.available() >> (field1310 ? 2 : 1));
	}
