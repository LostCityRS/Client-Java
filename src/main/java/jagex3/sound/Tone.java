...
public final class Tone {
	...
	@ObfuscatedName("db.d")
	public Filter field428;

	@ObfuscatedName("db.e")
	public Envelope field429;

	@ObfuscatedName("db.f")
	public Envelope field430;
	...
	@ObfuscatedName("db.i")
	public Envelope field433;

	@ObfuscatedName("db.j")
	public int field434 = 0;

	@ObfuscatedName("db.k")
	public Envelope field435;

	@ObfuscatedName("db.l")
	public Envelope field436;

	@ObfuscatedName("db.m")
	public Envelope field437;

	@ObfuscatedName("db.n")
	public Envelope field438;
	...
	public void method169(Packet arg0) {
		this.field425 = new Envelope();
		this.field425.method573(arg0);
		this.field435 = new Envelope();
		this.field435.method573(arg0);
		int var2 = arg0.g1();
		if (var2 != 0) {
			arg0.pos--;
			this.field430 = new Envelope();
			this.field430.method573(arg0);
			this.field433 = new Envelope();
			this.field433.method573(arg0);
		}
		int var3 = arg0.g1();
		if (var3 != 0) {
			arg0.pos--;
			this.field429 = new Envelope();
			this.field429.method573(arg0);
			this.field442 = new Envelope();
			this.field442.method573(arg0);
		}
		int var4 = arg0.g1();
		if (var4 != 0) {
			arg0.pos--;
			this.field438 = new Envelope();
			this.field438.method573(arg0);
			this.field437 = new Envelope();
		...
		for (int var5 = 0; var5 < 10; var5++) {
			...
			this.field439[var5] = arg0.gsmarts();
			this.field427[var5] = arg0.gsmart();
		}
		this.field444 = arg0.gsmart();
		this.field440 = arg0.gsmart();
		this.field447 = arg0.g2();
		this.field434 = arg0.g2();
		this.field428 = new Filter();
		this.field436 = new Envelope();
	...
	public int[] method170(int arg0, int arg1) {
		...
		if (this.field428.field1285[0] > 0 || this.field428.field1285[1] > 0) {
			...
			if (arg0 >= var30 + var31) {
				...
				while (var32 < var33) {
					int var34 = (int) ((long) field432[var32 + var30] * (long) Filter.field1288 >> 16);
					for (int var35 = 0; var35 < var30; var35++) {
						var34 += (int) ((long) field432[var32 + var30 - var35 - 1] * (long) Filter.field1284[0][var35] >> 16);
					}
					for (int var36 = 0; var36 < var32; var36++) {
						var34 -= (int) ((long) field432[var32 - var36 - 1] * (long) Filter.field1284[1][var36] >> 16);
					}
				...
				while (true) {
					...
					while (var32 < var37) {
						int var38 = (int) ((long) field432[var32 + var30] * (long) Filter.field1288 >> 16);
						for (int var39 = 0; var39 < var30; var39++) {
							var38 += (int) ((long) field432[var32 + var30 - var39 - 1] * (long) Filter.field1284[0][var39] >> 16);
						}
						for (int var40 = 0; var40 < var31; var40++) {
							var38 -= (int) ((long) field432[var32 - var40 - 1] * (long) Filter.field1284[1][var40] >> 16);
						}
					...
					if (var32 >= arg0 - var30) {
						while (var32 < arg0) {
							...
							for (int var42 = var32 + var30 - arg0; var42 < var30; var42++) {
								var41 += (int) ((long) field432[var32 + var30 - var42 - 1] * (long) Filter.field1284[0][var42] >> 16);
							}
							for (int var43 = 0; var43 < var31; var43++) {
								var41 -= (int) ((long) field432[var32 - var43 - 1] * (long) Filter.field1284[1][var43] >> 16);
							}
