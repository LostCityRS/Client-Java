...
public final class Tone {
	...
	@ObfuscatedName("ue.d")
	public static int[] field3084 = new int[32768];

	@ObfuscatedName("ue.e")
	public final int[] field3085 = new int[5];

	@ObfuscatedName("ue.f")
	public Envelope field3086;

	@ObfuscatedName("ue.g")
	public Envelope field3087;

	@ObfuscatedName("ue.h")
	public static int[] field3088 = new int[220500];

	@ObfuscatedName("ue.i")
	public final int[] field3089 = new int[5];

	@ObfuscatedName("ue.j")
	public Envelope field3090;
	...
	@ObfuscatedName("ue.m")
	public Envelope field3093;

	@ObfuscatedName("ue.n")
	public Envelope field3094;

	@ObfuscatedName("ue.o")
	public Envelope field3095;

	@ObfuscatedName("ue.p")
	public Envelope field3096;

	@ObfuscatedName("ue.q")
	public static int[] field3097 = new int[32768];

	@ObfuscatedName("ue.r")
	public static int[] field3098 = new int[5];

	@ObfuscatedName("ue.s")
	public static int[] field3099 = new int[5];

	@ObfuscatedName("ue.t")
	public int field3100 = 500;

	@ObfuscatedName("ue.u")
	public static int[] field3101 = new int[5];

	@ObfuscatedName("ue.v")
	public static int[] field3102 = new int[5];

	@ObfuscatedName("ue.w")
	public Envelope field3103;

	@ObfuscatedName("ue.y")
	public static int[] field3105 = new int[5];

	@ObfuscatedName("ue.x")
	public Envelope field3104;
			...
			if (arg0 >= var31 + var32) {
				...
				while (var33 < var34) {
					...
					for (int var37 = 0; var37 < var33; var37++) {
						var35 -= (int) ((long) field3088[var33 - var37 - 1] * (long) Filter.field821[1][var37] >> 16);
					}
				...
				while (true) {
					...
					while (var33 < var38) {
						...
						for (int var41 = 0; var41 < var32; var41++) {
							var39 -= (int) ((long) field3088[var33 - var41 - 1] * (long) Filter.field821[1][var41] >> 16);
						}
					...
					if (var33 >= arg0 - var31) {
						while (var33 < arg0) {
							...
							for (int var43 = var31 + var33 - arg0; var43 < var31; var43++) {
								var42 += (int) ((long) field3088[var31 + var33 - var43 - 1] * (long) Filter.field821[0][var43] >> 16);
							}
							for (int var44 = 0; var44 < var32; var44++) {
								var42 -= (int) ((long) field3088[var33 - var44 - 1] * (long) Filter.field821[1][var44] >> 16);
							}
