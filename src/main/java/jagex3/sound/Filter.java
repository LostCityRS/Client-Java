...
public final class Filter {
	...
	public void method430(Packet arg0, Envelope arg1) {
		int var3 = arg0.g1();
		...
		this.field1290[0] = arg0.g2();
		this.field1290[1] = arg0.g2();
		int var4 = arg0.g1();
		for (int var5 = 0; var5 < 2; var5++) {
			for (int var6 = 0; var6 < this.field1285[var5]; var6++) {
				this.field1291[var5][0][var6] = arg0.g2();
				this.field1286[var5][0][var6] = arg0.g2();
			}
		}
		for (int var7 = 0; var7 < 2; var7++) {
			for (int var8 = 0; var8 < this.field1285[var7]; var8++) {
				if ((var4 & 0x1 << var7 * 4 << var8) == 0) {
					...
					this.field1291[var7][1][var8] = arg0.g2();
					this.field1286[var7][1][var8] = arg0.g2();
				}
			}
		}
