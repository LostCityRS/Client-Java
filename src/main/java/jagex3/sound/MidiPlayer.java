...
public abstract class MidiPlayer extends MidiStream {
	...
	public final void method996(int arg0, int arg1, long arg2) {
		...
		if (Js5NetThread.field2180 == var5) {
			return;
		}
		Js5NetThread.field2180 = var5;
	...
	public final void method1000(long arg0) {
		for (int var3 = 0; var3 < 128; var3++) {
			int var4 = Timer.field1937[var3];
			Timer.field1937[var3] = 0;
			for (int var5 = 0; var5 < 16; var5++) {
				if ((var4 & 0x1 << var5) != 0) {
	...
	public final boolean method1001(int arg0, int arg1, int arg2, long arg3) {
		if ((arg0 & 0xE0) == 128) {
			...
			int var7 = Timer.field1937[arg1];
			if (arg0 < 144 || arg2 == 0) {
				Timer.field1937[arg1] = var7 & ~var6;
			} else if ((var7 & var6) == 0) {
				Timer.field1937[arg1] = var7 | var6;
			} else {
	...
	public static int method1002(int arg0) {
		...
		int var2 = (Js5NetThread.field2180 * var1 >> 8) * var1;
