...
public final class DataFile {
	...
	@ObfuscatedName("ud.b")
	public BufferedRandomAccessFile field4180 = null;
	...
	@ObfuscatedName("ud.g")
	public BufferedRandomAccessFile field4185 = null;
	...
	public boolean method1495(int arg0, int arg1, boolean arg2, byte[] arg3) {
		BufferedRandomAccessFile var5 = this.field4185;
		synchronized (this.field4185) {
			try {
				...
				if (arg2) {
					...
					this.field4180.method816(FileOnDisk.field4303, 0, 6);
				...
				this.field4180.method818((long) (arg1 * 6));
				this.field4180.method806(FileOnDisk.field4303, 6, 0);
				while (var7 < arg0) {
					int var9 = 0;
					if (arg2) {
						this.field4185.method818((long) (var6 * 520));
						try {
							this.field4185.method816(FileOnDisk.field4303, 0, 8);
					...
					FileOnDisk.field4303[7] = (byte) this.field4181;
					var8++;
					if (arg0 - var7 <= 512) {
						var9 = 0;
					}
					...
					this.field4185.method818((long) (var6 * 520));
					var6 = var9;
					this.field4185.method806(FileOnDisk.field4303, 8, 0);
	...
	public byte[] readFromFile(int arg0) {
		BufferedRandomAccessFile var2 = this.field4185;
		synchronized (this.field4185) {
			try {
				...
				if (var4 < 0 || this.field4183 < var4) {
					...
					while (var4 > var9) {
						...
						this.field4185.method816(FileOnDisk.field4303, 0, var12 + 8);
	...
	public boolean writeToFile(byte[] arg0, int arg1, int arg2) {
		BufferedRandomAccessFile var4 = this.field4185;
		synchronized (this.field4185) {
