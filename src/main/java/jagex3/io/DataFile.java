	...
	public byte[] method906(int arg0) {
		...
		synchronized (this.field2725) {
			try {
				...
				this.field2729.method1045(0, 6, Statics.field1126);
				int var4 = (Statics.field1126[5] & 0xFF) + ((Statics.field1126[3] & 0xFF) << 16) + ((Statics.field1126[4] & 0xFF) << 8);
				int var5 = (Statics.field1126[2] & 0xFF) + (((Statics.field1126[0] & 0xFF) << 16) + ((Statics.field1126[1] & 0xFF) << 8));
				if (var5 < 0 || var5 > this.field2737) {
					...
					while (var5 > var8) {
						...
						this.field2725.method1045(0, var12 + 8, Statics.field1126);
						int var13 = ((Statics.field1126[0] & 0xFF) << 8) + (Statics.field1126[1] & 0xFF);
						int var14 = ((Statics.field1126[4] & 0xFF) << 16) + ((Statics.field1126[5] & 0xFF) << 8) + (Statics.field1126[6] & 0xFF);
						int var15 = ((Statics.field1126[2] & 0xFF) << 8) + (Statics.field1126[3] & 0xFF);
						int var16 = Statics.field1126[7] & 0xFF;
						if (arg0 == var13 && var9 == var15 && this.field2740 == var16) {
							if (var14 >= 0 && (long) var14 <= this.field2725.method1042() / 520L) {
								var9++;
								for (int var19 = 0; var19 < var12; var19++) {
									var10[var8++] = Statics.field1126[var19 + 8];
								}
								var4 = var14;
								continue;
							}
		...
		synchronized (this.field2725) {
			try {
				...
				if (arg2) {
					...
					this.field2729.method1045(0, 6, Statics.field1126);
					var6 = (Statics.field1126[5] & 0xFF) + (((Statics.field1126[3] & 0xFF) << 16) + ((Statics.field1126[4] & 0xFF) << 8));
				...
				Statics.field1126[0] = (byte) (arg1 >> 16);
				Statics.field1126[1] = (byte) (arg1 >> 8);
				Statics.field1126[2] = (byte) arg1;
				int var7 = 0;
				Statics.field1126[3] = (byte) (var6 >> 16);
				int var8 = 0;
				Statics.field1126[4] = (byte) (var6 >> 8);
				Statics.field1126[5] = (byte) var6;
				this.field2729.method1041((long) (arg3 * 6));
				this.field2729.method1043(0, 6, Statics.field1126);
				while (var7 < arg1) {
					int var9 = 0;
					if (arg2) {
						this.field2725.method1041((long) (var6 * 520));
						try {
							this.field2725.method1045(0, 8, Statics.field1126);
						} catch (EOFException var14) {
							return true;
						}
						var9 = (Statics.field1126[6] & 0xFF) + (((Statics.field1126[4] & 0xFF) << 16) + ((Statics.field1126[5] & 0xFF) << 8));
						int var10 = ((Statics.field1126[0] & 0xFF) << 8) + (Statics.field1126[1] & 0xFF);
						int var11 = Statics.field1126[7] & 0xFF;
						int var12 = ((Statics.field1126[2] & 0xFF) << 8) + (Statics.field1126[3] & 0xFF);
					...
					Statics.field1126[0] = (byte) (arg3 >> 8);
					if (arg1 - var7 <= 512) {
						var9 = 0;
					}
					Statics.field1126[1] = (byte) arg3;
					int var13 = arg1 - var7;
					if (var13 > 512) {
						var13 = 512;
					}
					Statics.field1126[2] = (byte) (var8 >> 8);
					Statics.field1126[3] = (byte) var8;
					Statics.field1126[4] = (byte) (var9 >> 16);
					Statics.field1126[5] = (byte) (var9 >> 8);
					var8++;
					Statics.field1126[6] = (byte) var9;
					Statics.field1126[7] = (byte) this.field2740;
					this.field2725.method1041((long) (var6 * 520));
					this.field2725.method1043(0, 8, Statics.field1126);
					var6 = var9;
