...
public final class BZip2 {
	...
	public static byte method960(BZip2State arg0) {
	...
	public static void method962(BZip2State arg0) {
		arg0.field1950 = 1;
		if (field1309 == null) {
			field1309 = new int[arg0.field1950 * 100000];
		}
		boolean var1 = true;
		while (true) {
			while (var1) {
				...
				while (true) {
					while (var58 != var42) {
						if (var58 == 0 || var58 == 1) {
							...
							field1309[var48] = arg0.field1926[var68 & 0xFF] & 0xFF;
							var48++;
							if (var85 == 0) {
								var84++;
								var85 = 50;
					...
					for (int var82 = 0; var82 < var48; var82++) {
						byte var83 = (byte) (field1309[var82] & 0xFF);
						field1309[arg0.field1940[var83 & 0xFF]] |= var82 << 8;
						arg0.field1940[var83 & 0xFF]++;
					}
					arg0.field1951 = field1309[arg0.field1963] >> 8;
					arg0.field1946 = 0;
					arg0.field1951 = field1309[arg0.field1951];
	...
	public static byte method963(BZip2State arg0) {
	...
	public static int decompress(byte[] arg0, int arg1, byte[] arg2, int arg3) {
		...
		synchronized (state) {
			state.field1935 = arg2;
			state.field1923 = 9;
			state.field1945 = arg0;
			state.field1953 = 0;
			state.field1932 = arg1;
			state.field1934 = 0;
			state.field1937 = 0;
			state.field1956 = 0;
			state.field1967 = 0;
			method962(state);
			int var5 = arg1 - state.field1932;
			state.field1935 = null;
			state.field1945 = null;
			return var5;
		}
	}

	@ObfuscatedName("rd.a(ILm;)I")
	public static int method965(int arg0, BZip2State arg1) {
	...
	public static void method967(BZip2State arg0) {
		arg0.field1936 = 0;
	...
	public static void method968(BZip2State arg0) {
