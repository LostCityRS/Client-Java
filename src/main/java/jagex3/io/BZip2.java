...
public final class BZip2 {
	...
	public static int method1458(byte[] arg0, int arg1, byte[] arg2, int arg3) {
		...
		synchronized (state) {
			state.field3183 = arg2;
			state.field3151 = 9;
			state.field3169 = arg0;
			state.field3175 = 0;
			state.field3177 = arg1;
			state.field3178 = 0;
			state.field3184 = 0;
			state.field3166 = 0;
			state.field3170 = 0;
			method1462(state);
			int var5 = arg1 - state.field3177;
			state.field3183 = null;
			state.field3169 = null;
			return var5;
		}
	}

	@ObfuscatedName("th.a(Lpb;)B")
	public static byte method1459(BZip2State arg0) {
		return (byte) method1460(1, arg0);
	}

	@ObfuscatedName("th.a(ILpb;)I")
	public static int method1460(int arg0, BZip2State arg1) {
	...
	public static void method1462(BZip2State arg0) {
		arg0.field3181 = 1;
		if (Statics.field1831 == null) {
			Statics.field1831 = new int[arg0.field3181 * 100000];
		}
		boolean var1 = true;
		while (true) {
			while (var1) {
				...
				while (true) {
					while (var58 != var42) {
						if (var58 == 0 || var58 == 1) {
							...
							while (var59 > 0) {
								Statics.field1831[var48] = var65 & 0xFF;
								var48++;
								var59--;
							}
						} else {
							...
							Statics.field1831[var48] = arg0.field3158[var68 & 0xFF] & 0xFF;
							var48++;
							if (var85 == 0) {
								var84++;
								var85 = 50;
					...
					for (int var82 = 0; var82 < var48; var82++) {
						byte var83 = (byte) (Statics.field1831[var82] & 0xFF);
						Statics.field1831[arg0.field3157[var83 & 0xFF]] |= var82 << 8;
						arg0.field3157[var83 & 0xFF]++;
					}
					arg0.field3161 = Statics.field1831[arg0.field3162] >> 8;
					arg0.field3185 = 0;
					arg0.field3161 = Statics.field1831[arg0.field3161];
	...
	public static byte method1464(BZip2State arg0) {
		return (byte) method1460(8, arg0);
	}

	@ObfuscatedName("th.d(Lpb;)V")
	public static void method1465(BZip2State arg0) {
		arg0.field3172 = 0;
