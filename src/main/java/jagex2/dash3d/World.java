...
public class World {
				...
				for (int var10 = 0; var10 < 64; var10++) {
					...
					if (var11 >= 0 && var11 < 104 && var12 >= 0 && var12 < 104) {
						...
						while (true) {
							...
							if (var13 == 0) {
								if (var8 == 0) {
									this.heightmap[0][var11][var12] = -perlinNoise(var11 + 932731 + arg1, var12 + 556238 + arg3) * 8;
								} else {
	...
	public void loadLocations(int arg0, World3D arg1, int arg2, byte[] arg3, CollisionMap[] arg4) {
		...
		while (true) {
			...
			while (true) {
				...
				if (var19 > 0 && var20 > 0 && var19 < 103 && var20 < 103) {
					int var21 = var15;
					if ((this.flags[1][var19][var20] & 0x2) == 2) {
						var21 = var15 - 1;
					}
	...
	public void addLoc(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, CollisionMap arg6, int arg7, World3D arg8) {
		...
		if (lowMem) {
			...
			if (this.getDrawLevel(arg2, arg7, arg4) != levelBuilt) {
				return;
			}
		}
		int var10 = this.heightmap[arg4][arg2][arg7];
		int var11 = this.heightmap[arg4][arg2 + 1][arg7];
		int var12 = this.heightmap[arg4][arg2 + 1][arg7 + 1];
		int var13 = this.heightmap[arg4][arg2][arg7 + 1];
		...
		if (arg0 == 22) {
			if (!lowMem || var15.active || var15.forcedecor) {
				...
				arg8.addGroundDecor(var18, arg2, var16, arg4, arg7, var14, var17);
			...
			if (var19 != null) {
				...
				if (arg8.addLoc(var17, var21, var14, var19, var22, var16, arg7, arg2, var20, arg4) && var15.shadow) {
					Model var23;
			...
			arg8.addLoc(var17, 1, var14, var27, 1, var16, arg7, arg2, 0, arg4);
			if (arg0 >= 12 && arg0 <= 17 && arg0 != 13 && arg4 > 0) {
				this.occlusion[arg4][arg2][arg7] |= 0x924;
			}
			if (var15.blockwalk && arg6 != null) {
				arg6.addLoc(var15.blockrange, arg7, arg1, var15.width, var15.length, arg2);
			}
			...
			arg8.addWall(var28, null, var16, 0, arg7, var17, arg2, var14, ROTATION_WALL_TYPE[arg1], arg4);
			if (arg1 == 0) {
				if (var15.shadow) {
				...
				if (var15.occlude) {
					this.occlusion[arg4][arg2][arg7] |= 0x249;
				}
			} else if (arg1 == 1) {
				if (var15.shadow) {
					this.shadow[arg4][arg2][arg7 + 1] = 50;
				...
				if (var15.occlude) {
					this.occlusion[arg4][arg2][arg7 + 1] |= 0x492;
				}
			} else if (arg1 == 2) {
				if (var15.shadow) {
				...
				if (var15.occlude) {
					this.occlusion[arg4][arg2 + 1][arg7] |= 0x249;
				}
			} else if (arg1 == 3) {
				if (var15.shadow) {
					this.shadow[arg4][arg2][arg7] = 50;
				...
				if (var15.occlude) {
					this.occlusion[arg4][arg2][arg7] |= 0x492;
				}
			}
			if (var15.blockwalk && arg6 != null) {
			...
			arg8.addWall(var29, null, var16, 0, arg7, var17, arg2, var14, ROTATION_WALL_CORNER_TYPE[arg1], arg4);
			if (var15.shadow) {
				if (arg1 == 0) {
					this.shadow[arg4][arg2][arg7 + 1] = 50;
				} else if (arg1 == 1) {
			...
			arg8.addWall(var31, var32, var16, ROTATION_WALL_TYPE[var30], arg7, var17, arg2, var14, ROTATION_WALL_TYPE[arg1], arg4);
			if (var15.occlude) {
				if (arg1 == 0) {
					this.occlusion[arg4][arg2][arg7] |= 0x249;
					this.occlusion[arg4][arg2][arg7 + 1] |= 0x492;
			...
			arg8.addWall(var33, null, var16, 0, arg7, var17, arg2, var14, ROTATION_WALL_CORNER_TYPE[arg1], arg4);
			if (var15.shadow) {
				if (arg1 == 0) {
					this.shadow[arg4][arg2][arg7 + 1] = 50;
				} else if (arg1 == 1) {
			...
			arg8.addLoc(var17, 1, var14, var34, 1, var16, arg7, arg2, 0, arg4);
			if (var15.blockwalk && arg6 != null) {
				arg6.addLoc(var15.blockrange, arg7, arg1, var15.width, var15.length, arg2);
			}
		} else if (arg0 == 4) {
			...
			arg8.addDecor(ROTATION_WALL_TYPE[arg1], 0, var17, var14, arg2, var16, arg1 * 512, arg7, 0, var35, arg4);
		} else if (arg0 == 5) {
			int var36 = 16;
			int var37 = arg8.getWallTypecode(arg4, arg2, arg7);
			if (var37 > 0) {
			...
			arg8.addDecor(ROTATION_WALL_TYPE[arg1], WALL_DECORATION_ROTATION_FORWARD_X[arg1] * var36, var17, var14, arg2, var16, arg1 * 512, arg7, WALL_DECORATION_ROTATION_FORWARD_Z[arg1] * var36, var38, arg4);
		} else if (arg0 == 6) {
			ModelSource var39;
			if (var15.anim == -1) {
			...
			arg8.addDecor(256, 0, var17, var14, arg2, var16, arg1, arg7, 0, var39, arg4);
		} else if (arg0 == 7) {
			ModelSource var40;
			if (var15.anim == -1) {
			...
			arg8.addDecor(512, 0, var17, var14, arg2, var16, arg1, arg7, 0, var40, arg4);
		} else if (arg0 == 8) {
			ModelSource var41;
			if (var15.anim == -1) {
			...
			arg8.addDecor(768, 0, var17, var14, arg2, var16, arg1, arg7, 0, var41, arg4);
		}
	}

	@ObfuscatedName("c.a(Ls;[Ljc;I)V")
	public void build(World3D arg0, CollisionMap[] arg1) {
		...
		for (int var8 = 0; var8 < 4; var8++) {
			...
			for (int var17 = 1; var17 < this.maxTileZ - 1; var17++) {
				for (int var18 = 1; var18 < this.maxTileX - 1; var18++) {
					int var19 = this.heightmap[var8][var18 + 1][var17] - this.heightmap[var8][var18 - 1][var17];
					int var20 = this.heightmap[var8][var18][var17 + 1] - this.heightmap[var8][var18][var17 - 1];
					...
					this.lightness[var18][var17] = var25 - var26;
				}
			}
			for (int var27 = 0; var27 < this.maxTileZ; var27++) {
				this.blendChroma[var27] = 0;
				this.blendSaturation[var27] = 0;
				this.blendLightness[var27] = 0;
				this.blendLuminance[var27] = 0;
				this.blendMagnitude[var27] = 0;
			}
			for (int var28 = -5; var28 < this.maxTileX + 5; var28++) {
				for (int var29 = 0; var29 < this.maxTileZ; var29++) {
					...
					if (var30 >= 0 && var30 < this.maxTileX) {
						int var31 = this.underlayType[var8][var30][var29] & 0xFF;
						if (var31 > 0) {
							FloType var32 = FloType.types[var31 - 1];
							this.blendChroma[var29] += var32.chroma;
							this.blendSaturation[var29] += var32.saturation;
							this.blendLightness[var29] += var32.lightness;
							this.blendLuminance[var29] += var32.luminance;
							var10002 = this.blendMagnitude[var29]++;
						}
					}
					int var33 = var28 - 5;
					if (var33 >= 0 && var33 < this.maxTileX) {
						int var34 = this.underlayType[var8][var33][var29] & 0xFF;
						if (var34 > 0) {
							FloType var35 = FloType.types[var34 - 1];
							this.blendChroma[var29] -= var35.chroma;
							this.blendSaturation[var29] -= var35.saturation;
							this.blendLightness[var29] -= var35.lightness;
							this.blendLuminance[var29] -= var35.luminance;
							var10002 = this.blendMagnitude[var29]--;
						}
					}
				}
				if (var28 >= 1 && var28 < this.maxTileX - 1) {
					...
					for (int var41 = -5; var41 < this.maxTileZ + 5; var41++) {
						...
						if (var42 >= 0 && var42 < this.maxTileZ) {
							var36 += this.blendChroma[var42];
							var37 += this.blendSaturation[var42];
							var38 += this.blendLightness[var42];
							var39 += this.blendLuminance[var42];
							var40 += this.blendMagnitude[var42];
						}
						int var43 = var41 - 5;
						if (var43 >= 0 && var43 < this.maxTileZ) {
							var36 -= this.blendChroma[var43];
							var37 -= this.blendSaturation[var43];
							var38 -= this.blendLightness[var43];
							var39 -= this.blendLuminance[var43];
							var40 -= this.blendMagnitude[var43];
						}
						if (var41 >= 1 && var41 < this.maxTileZ - 1 && (!lowMem || (this.flags[var8][var28][var41] & 0x10) == 0 && this.getDrawLevel(var28, var41, var8) == levelBuilt)) {
							int var44 = this.underlayType[var8][var28][var41] & 0xFF;
							int var45 = this.overlayType[var8][var28][var41] & 0xFF;
							if (var44 > 0 || var45 > 0) {
								int var46 = this.heightmap[var8][var28][var41];
								int var47 = this.heightmap[var8][var28 + 1][var41];
								int var48 = this.heightmap[var8][var28 + 1][var41 + 1];
								int var49 = this.heightmap[var8][var28][var41 + 1];
								int var50 = this.lightness[var28][var41];
								int var51 = this.lightness[var28 + 1][var41];
								int var52 = this.lightness[var28 + 1][var41 + 1];
								int var53 = this.lightness[var28][var41 + 1];
								int var54 = -1;
								int var55 = -1;
								if (var44 > 0) {
									...
									var54 = this.hsl24to16(var56, var57, var58);
									int var59 = var56 + randomHueOffset & 0xFF;
									int var60 = var58 + randomLightnessOffset;
									if (var60 < 0) {
										var60 = 0;
									} else if (var60 > 255) {
										var60 = 255;
									}
									var55 = this.hsl24to16(var59, var57, var60);
								}
								if (var8 > 0) {
									boolean var61 = true;
									if (var44 == 0 && this.overlayShape[var8][var28][var41] != 0) {
										var61 = false;
									}
									...
									if (var61 && var46 == var47 && var46 == var48 && var46 == var49) {
										this.occlusion[var8][var28][var41] |= 0x924;
									}
								}
								int var62 = 0;
								if (var54 != -1) {
									var62 = Pix3D.colourTable[mulHsl(var55, 96)];
								}
								if (var45 == 0) {
									arg0.setTile(var8, var28, var41, 0, 0, -1, var46, var47, var48, var49, mulHsl(var54, var50), mulHsl(var54, var51), mulHsl(var54, var52), mulHsl(var54, var53), 0, 0, 0, 0, var62, 0);
								} else {
									int var63 = this.overlayShape[var8][var28][var41] + 1;
									byte var64 = this.overlayAngle[var8][var28][var41];
									...
									if (var66 >= 0) {
										...
										var68 = this.hsl24to16(var65.hue, var65.saturation, var65.lightness);
										var67 = Pix3D.colourTable[this.adjustLightness(var65.hsl, 96)];
									}
									arg0.setTile(var8, var28, var41, var63, var64, var66, var46, var47, var48, var49, mulHsl(var54, var50), mulHsl(var54, var51), mulHsl(var54, var52), mulHsl(var54, var53), this.adjustLightness(var68, var50), this.adjustLightness(var68, var51), this.adjustLightness(var68, var52), this.adjustLightness(var68, var53), var62, var67);
								}
							}
						}
					}
			...
			for (int var69 = 1; var69 < this.maxTileZ - 1; var69++) {
				for (int var70 = 1; var70 < this.maxTileX - 1; var70++) {
					arg0.setDrawLevel(var8, var70, var69, this.getDrawLevel(var70, var69, var8));
				}
			}
		}
		arg0.buildModels(768, 64, -10, -50, -50);
		for (int var71 = 0; var71 < this.maxTileX; var71++) {
			for (int var72 = 0; var72 < this.maxTileZ; var72++) {
				if ((this.flags[1][var71][var72] & 0x2) == 2) {
					arg0.setLinkBelow(var72, var71);
				}
			}
		}
		int var73 = 1;
			...
			for (int var77 = 0; var77 <= var76; var77++) {
				for (int var78 = 0; var78 <= this.maxTileZ; var78++) {
					for (int var79 = 0; var79 <= this.maxTileX; var79++) {
						if ((this.occlusion[var77][var79][var78] & var73) != 0) {
							int var80 = var78;
							int var81 = var78;
							int var82 = var77;
							int var83 = var77;
							while (var80 > 0 && (this.occlusion[var77][var79][var80 - 1] & var73) != 0) {
								var80--;
							}
							while (var81 < this.maxTileZ && (this.occlusion[var77][var79][var81 + 1] & var73) != 0) {
								var81++;
							}
							label325: while (var82 > 0) {
								for (int var84 = var80; var84 <= var81; var84++) {
									if ((this.occlusion[var82 - 1][var79][var84] & var73) == 0) {
										break label325;
									}
								}
								var82--;
							...
							label314: while (var83 < var76) {
								for (int var85 = var80; var85 <= var81; var85++) {
									if ((this.occlusion[var83 + 1][var79][var85] & var73) == 0) {
										break label314;
									}
								}
								var83++;
							...
							if (var86 >= 8) {
								short var87 = 240;
								int var88 = this.heightmap[var83][var79][var80] - var87;
								int var89 = this.heightmap[var82][var79][var80];
								World3D.addOccluder(var79 * 128, 1, var88, var79 * 128, var76, var89, var80 * 128, var81 * 128 + 128);
								for (int var90 = var82; var90 <= var83; var90++) {
									for (int var91 = var80; var91 <= var81; var91++) {
										this.occlusion[var90][var79][var91] &= ~var73;
									}
								}
							}
						}
						if ((this.occlusion[var77][var79][var78] & var74) != 0) {
							int var92 = var79;
							int var93 = var79;
							int var94 = var77;
							int var95 = var77;
							while (var92 > 0 && (this.occlusion[var77][var92 - 1][var78] & var74) != 0) {
								var92--;
							}
							while (var93 < this.maxTileX && (this.occlusion[var77][var93 + 1][var78] & var74) != 0) {
								var93++;
							}
							label378: while (var94 > 0) {
								for (int var96 = var92; var96 <= var93; var96++) {
									if ((this.occlusion[var94 - 1][var96][var78] & var74) == 0) {
										break label378;
									}
								}
								var94--;
							...
							label367: while (var95 < var76) {
								for (int var97 = var92; var97 <= var93; var97++) {
									if ((this.occlusion[var95 + 1][var97][var78] & var74) == 0) {
										break label367;
									}
								}
								var95++;
							...
							if (var98 >= 8) {
								short var99 = 240;
								int var100 = this.heightmap[var95][var92][var78] - var99;
								int var101 = this.heightmap[var94][var92][var78];
								World3D.addOccluder(var92 * 128, 2, var100, var93 * 128 + 128, var76, var101, var78 * 128, var78 * 128);
								for (int var102 = var94; var102 <= var95; var102++) {
									for (int var103 = var92; var103 <= var93; var103++) {
										this.occlusion[var102][var103][var78] &= ~var74;
									}
								}
							}
						}
						if ((this.occlusion[var77][var79][var78] & var75) != 0) {
							int var104 = var79;
							int var105 = var79;
							int var106 = var78;
							int var107 = var78;
							while (var106 > 0 && (this.occlusion[var77][var79][var106 - 1] & var75) != 0) {
								var106--;
							}
							while (var107 < this.maxTileZ && (this.occlusion[var77][var79][var107 + 1] & var75) != 0) {
								var107++;
							}
							label431: while (var104 > 0) {
								for (int var108 = var106; var108 <= var107; var108++) {
									if ((this.occlusion[var77][var104 - 1][var108] & var75) == 0) {
										break label431;
									}
								}
								var104--;
							...
							label420: while (var105 < this.maxTileX) {
								for (int var109 = var106; var109 <= var107; var109++) {
									if ((this.occlusion[var77][var105 + 1][var109] & var75) == 0) {
										break label420;
									}
								}
								var105++;
							...
							if ((var105 - var104 + 1) * (var107 - var106 + 1) >= 4) {
								int var110 = this.heightmap[var77][var104][var106];
								World3D.addOccluder(var104 * 128, 4, var110, var105 * 128 + 128, var76, var110, var106 * 128, var107 * 128 + 128);
								for (int var111 = var104; var111 <= var105; var111++) {
									for (int var112 = var106; var112 <= var107; var112++) {
										this.occlusion[var77][var111][var112] &= ~var75;
									}
								}
							}
						}
	...
	public int getDrawLevel(int arg1, int arg2, int arg3) {
		if ((this.flags[arg3][arg1][arg2] & 0x8) == 0) {
			return arg3 <= 0 || (this.flags[1][arg1][arg2] & 0x2) == 0 ? arg3 : arg3 - 1;
		} else {
			return 0;
		}
	}
	...
	public static void addLoc(int arg0, int arg1, CollisionMap arg2, int arg3, int arg4, int arg5, World3D arg6, int[][][] arg7, int arg9, int arg10) {
		...
		if (arg4 == 22) {
			...
			arg6.addGroundDecor(var19, arg1, var17, arg10, arg3, var15, var18);
			...
			if (var20 != null) {
				...
				arg6.addLoc(var18, var22, var15, var20, var23, var17, arg3, arg1, var21, arg10);
			}
			if (var16.blockwalk) {
			...
			arg6.addLoc(var18, 1, var15, var24, 1, var17, arg3, arg1, 0, arg10);
			if (var16.blockwalk) {
				arg2.addLoc(var16.blockrange, arg3, arg0, var16.width, var16.length, arg1);
			}
		} else if (arg4 == 0) {
			...
			arg6.addWall(var25, null, var17, 0, arg3, var18, arg1, var15, ROTATION_WALL_TYPE[arg0], arg10);
			if (var16.blockwalk) {
			...
			arg6.addWall(var26, null, var17, 0, arg3, var18, arg1, var15, ROTATION_WALL_CORNER_TYPE[arg0], arg10);
			if (var16.blockwalk) {
				arg2.addWall(arg1, arg3, arg0, var16.blockrange, arg4);
			}
		} else if (arg4 == 2) {
			...
			arg6.addWall(var28, var29, var17, ROTATION_WALL_TYPE[var27], arg3, var18, arg1, var15, ROTATION_WALL_TYPE[arg0], arg10);
			if (var16.blockwalk) {
				arg2.addWall(arg1, arg3, arg0, var16.blockrange, arg4);
			}
		} else if (arg4 == 3) {
			...
			arg6.addWall(var30, null, var17, 0, arg3, var18, arg1, var15, ROTATION_WALL_CORNER_TYPE[arg0], arg10);
			if (var16.blockwalk) {
				arg2.addWall(arg1, arg3, arg0, var16.blockrange, arg4);
			}
		} else if (arg4 == 9) {
			...
			arg6.addLoc(var18, 1, var15, var31, 1, var17, arg3, arg1, 0, arg10);
			if (var16.blockwalk) {
				arg2.addLoc(var16.blockrange, arg3, arg0, var16.width, var16.length, arg1);
			}
		} else if (arg4 == 4) {
			...
			arg6.addDecor(ROTATION_WALL_TYPE[arg0], 0, var18, var15, arg1, var17, arg0 * 512, arg3, 0, var32, arg10);
		} else if (arg4 == 5) {
			int var33 = 16;
			int var34 = arg6.getWallTypecode(arg10, arg1, arg3);
			if (var34 > 0) {
			...
			arg6.addDecor(ROTATION_WALL_TYPE[arg0], WALL_DECORATION_ROTATION_FORWARD_X[arg0] * var33, var18, var15, arg1, var17, arg0 * 512, arg3, WALL_DECORATION_ROTATION_FORWARD_Z[arg0] * var33, var35, arg10);
		} else if (arg4 == 6) {
			ModelSource var36;
			if (var16.anim == -1) {
			...
			arg6.addDecor(256, 0, var18, var15, arg1, var17, arg0, arg3, 0, var36, arg10);
		} else if (arg4 == 7) {
			ModelSource var37;
			if (var16.anim == -1) {
			...
			arg6.addDecor(512, 0, var18, var15, arg1, var17, arg0, arg3, 0, var37, arg10);
		} else if (arg4 == 8) {
			ModelSource var38;
			if (var16.anim == -1) {
			...
			arg6.addDecor(768, 0, var18, var15, arg1, var17, arg0, arg3, 0, var38, arg10);
		}
	}
}
