...
public class WordFilter {
	...
	@ObfuscatedName("sc.d")
	public static int field1170 = -48;

	@ObfuscatedName("sc.e")
	public static byte field1171 = 117;

	@ObfuscatedName("sc.f")
	public static byte field1172 = -13;

	@ObfuscatedName("sc.g")
	public static int field1173 = 6;

	@ObfuscatedName("sc.h")
	public static int field1174 = -35226;

	@ObfuscatedName("sc.i")
	public static int field1175;

	@ObfuscatedName("sc.j")
	public static int field1176 = 881;

	@ObfuscatedName("sc.k")
	public static int field1177;

	@ObfuscatedName("sc.l")
	public static int field1178 = -864;

	@ObfuscatedName("sc.m")
	public static boolean field1179 = true;

	@ObfuscatedName("sc.n")
	public static boolean field1180 = true;

	@ObfuscatedName("sc.o")
	public static byte field1181 = 7;

	@ObfuscatedName("sc.p")
	public static int field1182 = -28760;
	...
	public static final void method395(Packet arg0, int arg1) {
	...
	public static final void method396(int arg0, Packet arg1) {
	...
	public static final void method397(Packet arg0, int arg1) {
		if (arg1 >= 0) {
	...
	public static final void method398(Packet arg0, byte arg1) {
	...
	public static final void method399(char[][] arg0, Packet arg1, int arg2, byte[][][] arg3) {
	...
	public static final void method400(Packet arg0, char[][] arg1, int arg2) {
		if (arg2 >= 0) {
			return;
		}
	...
	public static final void method401(char[] arg0, byte arg1) {
		int var2 = 0;
	...
	public static final boolean method402(int arg0, char arg1) {
		if (arg0 != -37569) {
			for (int var2 = 1; var2 > 0; var2++) {
			}
		}
	...
	public static final void method405(char[] arg0, byte arg1) {
		if (arg1 == 6) {
			boolean var2 = false;
		} else {
			field1169 = 106;
	...
	public static final void method406(char[] arg0, boolean arg1) {
		if (!arg1) {
			for (int var2 = 1; var2 > 0; var2++) {
			}
		}
	...
	public static final void method407(int arg0, char[] arg1) {
		if (arg0 <= 0) {
			for (int var2 = 1; var2 > 0; var2++) {
			}
		}
	...
	public static final void method408(char[] arg0, int arg1, char[] arg2, char[] arg3, char[] arg4) {
	...
	public static final int method409(int arg0, char[] arg1, char[] arg2, int arg3) {
		if (arg3 != -35226) {
			field1183 = !field1183;
		}
		if (arg0 == 0) {
	...
	public static final int method410(char[] arg0, int arg1, int arg2, char[] arg3) {
	...
	public static final void method411(char[] arg0, int arg1) {
	...
	public static final void method412(char[] arg0, int arg1, char[] arg2, char[] arg3, char[] arg4, int arg5) {
		...
		for (int var7 = 0; var7 <= arg0.length - arg3.length; var7 += var10) {
			...
			label130: while (true) {
				while (true) {
					...
					int var14;
					if (var9 < arg3.length && (var14 = method417(arg3[var9], var12, var13, field1177)) > 0) {
						var8 += var14;
						var9++;
					} else {
						if (var9 == 0) {
						...
						int var15;
						if ((var15 = method417(arg3[var9 - 1], var12, var13, field1177)) > 0) {
							var8 += var15;
							if (var9 == 1) {
								var10++;
							}
						} else {
							if (var9 >= arg3.length || !method423(var12, true)) {
								break label130;
							}
							var8++;
						}
			...
			if (var9 >= arg3.length) {
				boolean var16 = false;
				int var17 = method413(false, arg4, var7, arg0);
				int var18 = method414(var8 - 1, arg0, arg2, (byte) 0);
				...
				if (var16) {
					...
					if (var17 > 2) {
						...
						for (int var24 = var19 - 1; var24 >= 0; var24--) {
							if (var23) {
								if (method423(arg0[var24], true)) {
									break;
								}
								var19 = var24;
							} else if (!method423(arg0[var24], true)) {
								var23 = true;
								var19 = var24;
							}
						}
					...
					if (var18 > 2) {
						...
						for (int var28 = var20 + 1; var28 < arg0.length; var28++) {
							if (var27) {
								if (method423(arg0[var28], true)) {
									break;
								}
								var20 = var28;
							} else if (!method423(arg0[var28], true)) {
								var27 = true;
								var20 = var28;
							}
						}
	...
	public static final int method413(boolean arg0, char[] arg1, int arg2, char[] arg3) {
		if (arg2 == 0) {
			return 2;
		}
		int var4 = arg2 - 1;
	...
	public static final int method414(int arg0, char[] arg1, char[] arg2, byte arg3) {
	...
	public static final boolean method416(byte arg0, int arg1, byte[][] arg2, byte arg3) {
		int var4 = 0;
		if (arg1 <= 0) {
			field1169 = 234;
		}
	...
	public static final int method417(char arg0, char arg1, char arg2, int arg3) {
		if (arg3 != 0) {
			return field1170;
		} else if (arg0 == arg1) {
			return 1;
	...
	public static final int method418(char arg0, char arg1, int arg2, char arg3) {
		if (arg2 >= 0) {
			field1179 = !field1179;
		}
		if (arg0 == arg3) {
	...
	public static final byte method419(char arg0, boolean arg1) {
		if (!arg1) {
			field1169 = -95;
		}
		if (arg0 >= 'a' && arg0 <= 'z') {
	...
	public static final void method420(char[] arg0, int arg1) {
		boolean var2 = false;
		int var3 = 0;
		int var4 = 0;
		if (arg1 < 9 || arg1 > 9) {
		...
		while (true) {
			do {
				int var8;
				if ((var8 = method421(field1180, arg0, var3)) == -1) {
					return;
				}
				boolean var6 = false;
				for (int var7 = var3; var7 >= 0 && var7 < var8 && !var6; var7++) {
					if (!method423(arg0[var7], true) && !method424(arg0[var7], true)) {
						var6 = true;
					}
				}
				if (var6) {
				...
				var3 = method422(var8, arg0, (byte) 7);
				int var9 = 0;
	...
	public static final int method421(boolean arg0, char[] arg1, int arg2) {
		if (!arg0) {
			return field1178;
		}
	...
	public static final int method422(int arg0, char[] arg1, byte arg2) {
		int var3 = arg0;
		while (true) {
	...
	public static final boolean method423(char arg0, boolean arg1) {
		if (!arg1) {
	...
	public static final boolean method424(char arg0, boolean arg1) {
		if (!arg1) {
			throw new NullPointerException();
	...
	public static final boolean method426(int arg0, char arg1) {
		int var2 = 23 / arg0;
		return arg1 >= '0' && arg1 <= '9';
	}

	@ObfuscatedName("sc.a(CI)Z")
	public static final boolean method427(char arg0, int arg1) {
		if (arg1 != field1182) {
			field1167 = 81;
		}
	...
	public static final boolean method428(char arg0, int arg1) {
		while (arg1 >= 0) {
			for (int var2 = 1; var2 > 0; var2++) {
			}
		}
	...
	public static final boolean method429(int arg0, char[] arg1) {
		if (arg0 != 0) {
			throw new NullPointerException();
		}
		boolean var2 = true;
		for (int var3 = 0; var3 < arg1.length; var3++) {
			if (!method426(470, arg1[var3]) && arg1[var3] != 0) {
				var2 = false;
			}
		}
		if (var2) {
