...
public class InputTracking {
	...
	public static final synchronized Packet method47(int arg0) {
		...
		if (field150 != null && field150.pos > 0 && enabled) {
			var1 = field150;
		}
		method45(field145);
		return var1;
	...
	public static final synchronized void mousePressed(int arg0, boolean arg1, int arg2, int arg3) {
		...
		field150.p1((int) var6);
		field150.p3((arg2 << 10) + arg0);
	}
	...
	public static final synchronized void mouseMoved(int arg0, int arg1, int arg2) {
		...
		if (arg0 - field155 < 8 && arg0 - field155 >= -8 && arg2 - field156 < 8 && arg2 - field156 >= -8) {
			...
			field150.p1(5);
			field150.p1((int) var6);
			field150.p1((arg2 - field156 + 8 << 4) + arg0 - field155 + 8);
		} else if (arg0 - field155 < 128 && arg0 - field155 >= -128 && arg2 - field156 < 128 && arg2 - field156 >= -128) {
			method48(field146, 4);
			field150.p1(6);
			field150.p1((int) var6);
			field150.p1(arg0 - field155 + 128);
			field150.p1(arg2 - field156 + 128);
		} else {
			method48(field146, 5);
			field150.p1(7);
			field150.p1((int) var6);
