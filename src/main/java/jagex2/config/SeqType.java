...
public class SeqType {
	...
	public static void method383(JagFile arg1) {
		Packet var2 = new Packet(arg1.method309("seq.dat", null));
		...
		for (int var3 = 0; var3 < field1111; var3++) {
			...
			field1112[var3].method385(var2);
		}
	}

	@ObfuscatedName("nc.a(BI)I")
	public int method384(int arg1) {
		int var3 = this.field1116[arg1];
		if (var3 == 0) {
			AnimFrame var4 = AnimFrame.method61(this.field1114[arg1]);
			if (var4 != null) {
	...
	public void method385(Packet arg1) {
		while (true) {
