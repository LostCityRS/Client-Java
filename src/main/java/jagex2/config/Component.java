...
public class Component {
	...
	public static void method32(Jagfile arg0, int arg1, Jagfile arg2, PixFont[] arg3) {
		...
		while (true) {
			...
			do {
				...
				var8.field81 = var4.g1();
				var8.field82 = var4.g2();
				var8.field83 = var4.g2();
				var8.field84 = var4.g2();
				var8.field85 = (byte) var4.g1();
				var8.field91 = var4.g1();
				if (var8.field91 == 0) {
					var8.field91 = -1;
				} else {
					var8.field91 = (var8.field91 - 1 << 8) + var4.g1();
				}
				int var9 = var4.g1();
				if (var9 > 0) {
					...
					for (int var10 = 0; var10 < var9; var10++) {
						var8.field89[var10] = var4.g1();
						var8.field90[var10] = var4.g2();
					}
				}
				int var11 = var4.g1();
				if (var11 > 0) {
					...
					for (int var12 = 0; var12 < var11; var12++) {
						...
						for (int var14 = 0; var14 < var13; var14++) {
							var8.field88[var12][var14] = var4.g2();
						}
					}
				}
				if (var8.field80 == 0) {
					var8.field92 = var4.g2();
					...
					for (int var16 = 0; var16 < var15; var16++) {
						var8.field95[var16] = var4.g2();
						var8.field96[var16] = var4.g2b();
						var8.field97[var16] = var4.g2b();
					}
				}
				if (var8.field80 == 1) {
				...
				if (var8.field80 == 2) {
					...
					var8.field100 = var4.g1() == 1;
					var8.field101 = var4.g1() == 1;
					var8.field102 = var4.g1() == 1;
					var8.field103 = var4.g1();
					var8.field104 = var4.g1();
					...
					for (int var17 = 0; var17 < 20; var17++) {
						int var19 = var4.g1();
						if (var19 == 1) {
							var8.field106[var17] = var4.g2b();
							var8.field107[var17] = var4.g2b();
					...
					for (int var18 = 0; var18 < 5; var18++) {
						var8.field108[var18] = var4.gjstr();
				...
				if (var8.field80 == 3) {
					var8.field109 = var4.g1() == 1;
				}
				if (var8.field80 == 4 || var8.field80 == 1) {
					var8.field110 = var4.g1() == 1;
					int var22 = var4.g1();
					if (arg3 != null) {
						var8.field112 = arg3[var22];
					}
					var8.field111 = var4.g1() == 1;
				}
				if (var8.field80 == 4) {
					var8.field113 = var4.gjstr();
					var8.field114 = var4.gjstr();
				}
				if (var8.field80 == 1 || var8.field80 == 3 || var8.field80 == 4) {
					var8.field115 = var4.g4();
				}
				if (var8.field80 == 3 || var8.field80 == 4) {
					var8.field116 = var4.g4();
					var8.field117 = var4.g4();
				}
				if (var8.field80 == 5) {
				...
				if (var8.field80 == 6) {
					...
					if (var27 != 0) {
						var8.field120 = 1;
						var8.field121 = (var27 - 1 << 8) + var4.g1();
					}
					int var28 = var4.g1();
					if (var28 != 0) {
						var8.field122 = 1;
						var8.field123 = (var28 - 1 << 8) + var4.g1();
					}
					int var29 = var4.g1();
					if (var29 == 0) {
						var8.field124 = -1;
					} else {
						var8.field124 = (var29 - 1 << 8) + var4.g1();
					}
					int var30 = var4.g1();
					if (var30 == 0) {
						var8.field125 = -1;
					} else {
						var8.field125 = (var30 - 1 << 8) + var4.g1();
					}
					var8.field126 = var4.g2();
					var8.field127 = var4.g2();
				...
				if (var8.field80 == 7) {
					...
					var8.field111 = var4.g1() == 1;
					var8.field115 = var4.g4();
					var8.field103 = var4.g2b();
					var8.field104 = var4.g2b();
					var8.field101 = var4.g1() == 1;
					var8.field108 = new String[5];
					for (int var32 = 0; var32 < 5; var32++) {
						var8.field108[var32] = var4.gjstr();
				...
				if (var8.field81 == 2 || var8.field80 == 2) {
					...
					var8.field130 = var4.gjstr();
					var8.field131 = var4.g2();
				}
			} while (var8.field81 != 1 && var8.field81 != 4 && var8.field81 != 5 && var8.field81 != 6);
			var8.field132 = var4.gjstr();
	...
	public Model method35(int arg0, int arg1) {
		Model var3 = (Model) field133.get((long) ((arg0 << 16) + arg1));
		if (var3 != null) {
			return var3;
		}
		if (arg0 == 1) {
		...
		if (var3 != null) {
			field133.put(var3, (long) ((arg0 << 16) + arg1), 39399);
		}
		return var3;
	}
	...
	public static void method36(Model arg0, int arg1, int arg2, int arg3) {
		...
		if (arg1 > 0 && (arg0 != null && arg3 != 4)) {
			field133.put(arg0, (long) ((arg3 << 16) + arg2), 39399);
		}
	}
	...
	public static Pix32 method37(int arg0, Jagfile arg1, int arg2, String arg3) {
		...
		Pix32 var6 = (Pix32) field134.get(var4);
		if (arg2 != -18993) {
			field71 = 299;
		}
		if (var6 != null) {
