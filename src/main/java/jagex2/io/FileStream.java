...
public class FileStream {
	...
	public FileStream(int arg0, RandomAccessFile arg1, RandomAccessFile arg2, int arg4) {
		this.archive = arg0;
		this.dat = arg2;
		this.idx = arg1;
	...
	public synchronized boolean write(byte[] arg0, int arg1, int arg3) {
		boolean var5 = this.write(arg0, arg1, true, arg3);
		if (!var5) {
			var5 = this.write(arg0, arg1, false, arg3);
		}
		return var5;
	}

	@ObfuscatedName("wb.a([BIZII)Z")
	public synchronized boolean write(byte[] arg0, int arg1, boolean arg2, int arg4) {
		try {
			int var8;
			if (arg2) {
				this.seek(arg1 * 6, this.idx);
