			...
			if (var5.field676 == 64) {
				for (int var9 = 0; var9 < 128; var9++) {
					for (int var10 = 0; var10 < 128; var10++) {
						var1[var10 + (var9 << 7)] = var6[var5.field674[(var10 >> 1) + (var9 >> 1 << 6)]];
					}
				}
			} else {
	...
	public static final void method186(double arg1) {
		...
		for (int var7 = 0; var7 < 512; var7++) {
			...
			for (int var12 = 0; var12 < 128; var12++) {
				...
				int var35 = method187(var34, var3);
				field657[var5++] = var35;
			}
		}
		for (int var36 = 0; var36 < 50; var36++) {
			if (field649[var36] != null) {
				int[] var37 = field649[var36].field675;
				field658[var36] = new int[var37.length];
				for (int var38 = 0; var38 < var37.length; var38++) {
					field658[var36][var38] = method187(var37[var38], var3);
				}
			}
		}
